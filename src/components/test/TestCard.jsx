  ...
  return (
    <div className="relative">
      ...
      <div className="border-t border-gray-100 pt-2 mt-auto flex items-center justify-between">
        ...
        <a
          href={`https://docs.google.com/forms/d/e/1FAIpQLScp-_BbFAEK5fDaQs7uz9qr8jyFz3aKGZxbdounzM0B_y2GZw/viewform?usp=pp_url&entry.1573049792=${encodeURIComponent(test.name + ' (' + test.id + ')')}`}
          target="_blank"
