...
// ============================================================================
// Configuration - imports display labels from journeyConfig.js
// ============================================================================

// Get MRD journey configuration for colors and label
...
// Step content - uses labels from JOURNEY_CONFIG for cross-references
const CONTENT = {
  welcome: {
    headline: "Confirming You're Cancer-Free",
    afterTreatment: {
      boldText: 'After treatment ends',
      text: ', MRD (minimal residual disease) tests can detect tiny traces of cancer in your blood — confirming treatment worked.',
    },
    earlyDetection: {
  ...
  treatmentStatus: {
    ...
    preTreatmentWarning: {
      ...
      // Uses the "Choosing" journey display label from config
      get text() {
  ...
  return (
    <div className="py-6">
      ...
      <NavigationButtons
        ...
        nextLabel={wizardData.treatmentStatus === 'pre-treatment' ? content.continueAnywayLabel : BUTTONS.continue}
      />
    </div>
  );
}
...
function ResultsStep({ wizardData, testData, onNext, onBack }) {
  ...
  // For now, show placeholder cards. Real filtering would happen with testData
  const getMatchingTests = () => {
    // Placeholder matching logic - in production, filter testData based on wizardData
    return [
      {
        id: 'signatera',
        name: 'Signatera',
...
function NextStepsStep({ wizardData, onBack, onComplete }) {
  ...
  return (
    <div className="py-6">
      ...
      <p className="text-slate-600 text-center mb-8">
        Here's how to move forward with MRD testing
      </p>
      ...
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <InfoBox>
          ...
          <p className="text-slate-700 text-sm">
            Bring this information to your next appointment. Your oncologist can help determine which test
            is right for your specific situation, and can order the test directly.
          </p>
        </InfoBox>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 text-center">
          <p className="text-slate-600 text-sm mb-3">
            Want to save your results and track your MRD testing journey?
          </p>
...
/**
 * MrdWizard - Multi-step wizard for MRD test discovery
 *
 ...
 *
 * Display label (e.g., "Watching") comes from journeyConfig.js
 * To change "Watching" to "Guarding", edit JOURNEY_CONFIG.mrd.label in journeyConfig.js
 *
 * @param {Object} props
 ...
 */
export default function MrdWizard({ onComplete, onBack, testData = [] }) {
  // Current step in the wizard (0-indexed)
  const [currentStep, setCurrentStep] = useState(0);

  // Wizard data collected from user
  const [wizardData, setWizardData] = useState({
    cancerType: null,           // Selected cancer type or 'not-sure'
      ...
      <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-semibold text-slate-900">{mrdJourney.label} Journey</h1>
