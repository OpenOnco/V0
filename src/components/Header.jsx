    ...
    <header className="bg-white border-b-2 border-brand-600 sticky top-0 z-40">
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 text-sm sm:text-[15px] font-bold text-brand-600 bg-white hover:bg-brand-50 rounded-xl transition shadow-sm cursor-pointer border-2 border-brand-600"
        >
