...
export const mrdTestData = [
  {
    ...
    "method": "AI-powered tumor-informed MRD detection using machine learning algorithms on cfDNA sequencing data.",
    "cancerTypes": [
      "Colorectal",
      "Breast",
      "Lung"
    ],
    "indicationsNotes": "Experimental AI-enhanced MRD platform for testing purposes.",
    "sensitivity": 92.5,
    "sensitivityCitations": "https://ryght.ai/clinical-data",
    "sensitivityNotes": "Test data - 92.5% overall sensitivity in validation cohort.",
    "specificity": 95,
    "specificityNotes": "~95% estimated specificity (vendor estimate).",
    "lod": "5 ppm",
    "lodCitations": "https://ryght.ai/technical-specs",
    "lodNotes": "Analytical limit of detection approximately 5 parts per million; varies by underlying assay.",
    "lod95": null,
    "requiresTumorTissue": "Yes",
    "requiresMatchedNormal": "Yes",
    "variantsTracked": "100",
    "initialTat": 14,
    "initialTatNotes": "Initial turnaround time approximately 2 weeks.",
    "followUpTat": 5,
    "bloodVolume": 20,
    "fdaStatus": "RUO/Software Platform",
    "fdaStatusNotes": "Research Use Only software platform; not a direct diagnostic test.",
    "reimbursement": "Not applicable",
    "reimbursementNote": "Software/platform - no direct reimbursement; underlying assays may have separate coverage.",
    "listPrice": null,
    "clinicalAvailability": "Research Use Only",
    "clinicalTrials": null,
    "clinicalSettings": ["Post-Surgery"],
    "totalParticipants": null,
    "numPublications": 2,
    "numPublicationsNotes": "Two conference abstracts presented."
  },
  {
    "id": "mrd-1",
    "sampleCategory": "Blood/Plasma",
