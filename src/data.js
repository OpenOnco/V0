...
export const mrdTestData = [
    ...
    }},
  {
    ...
    "indicationsNotes": "Personalis NeXT Personal Dx tumor-informed MRD assay. Medicare-covered for early-stage breast cancer recurrence monitoring ($4,266/test, effective Oct 7 2025); clinical data in CRC, NSCLC (TRACERx: 431 pts, 5x relapse risk, Cell Dec 2025), and cervical cancer (CALLA trial: detection 16 months ahead of imaging).",
    "sensitivity": 100,
    ...
    "clinicalSettings": ["Post-Surgery", "Post-Adjuvant", "Surveillance", "Immunotherapy monitoring"],
    ...
    "totalParticipants": 924,
    "totalParticipantsNotes": "493 (analytical validation) + 431 (TRACERx NSCLC)",
    "numPublications": 7,
