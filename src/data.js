...
export const COMPANY_CONTRIBUTIONS = {
  ...
  'mrd-19': {  // clonoSEQ (vendor validation + edits)
    name: 'Christine Hanley',
    company: 'Adaptive Biotechnologies',
    verifiedDate: '2026-04-02',
    note: 'Full vendor validation with 6 edits: numPublications (>250), clinicalTrials (190+ trials, 51K+ patients), variantsTracked, bloodVolume, fdaStatus, reimbursement'
  },
...
export const VENDOR_ASSISTANCE_PROGRAMS = {
  'Natera': {
    ...
    description: 'Financial assistance ($0–$149 based on income) and prompt-pay cash pricing ($249–$449) to reduce patient out-of-pocket cost. Interest-free 12-month payment plans available.',
    eligibility: 'Needs-based financial assistance for qualifying individuals/families; income verification required. Based on household size and income (Federal Poverty Level guidelines). Uninsured patients eligible.',
    maxOutOfPocket: '$149 (financial assistance); $449 (prompt-pay cash for oncology)',
    promptPayCash: {
      signatera: '$349 (prompt-pay within 60 days of billing)',
      altera: '$449',
      panorama: '$249',
      horizon: '$349'
    },
    financialAssistanceTiers: '$0–$149 based on income and household size',
    paymentPlans: 'Interest-free payment plans for 12 months',
    applicationUrl: 'https://care.natera.com/',
    applicationUrlAlt: 'https://compassion.natera.com/s/',
    applicationNotes: 'Financial assistance application at care.natera.com; also available via Compassionate Care portal',
    ...
    oncologyBillingContact: '650-489-9050 or signaterapc@natera.com (Signatera/Altera-specific)',
    dedicatedCoordinators: true,
    sourceCitations: [
      'https://www.natera.com/oncology/billing/',
      'https://care.natera.com/',
    ...
    eligibilityRules: {
      fplThresholds: [
        { maxFPL: 100, discount: '100%', maxOOP: '$0', notes: 'Free testing at or below FPL' },
        { maxFPL: 400, discount: 'Sliding scale', maxOOP: '$149', notes: 'Financial assistance $0–$149 based on income' }
      ],
      householdSizeConsidered: true,
      requiredDocumentation: ['Income verification required'],
      uninsuredEligible: true,
      paymentPlanTerms: 'Interest-free payment plans for 12 months',
      promptPayOption: 'Cash pricing $249–$449 within 60 days of billing (no income verification needed)',
      applicationUrl: 'https://care.natera.com/',
  ...
  'Myriad Genetics': {
    ...
    hasProgram: true,
    tests: ['MyChoice CDx', 'BRACAnalysis CDx', 'Precise MRD'],
...
export const mrdTestData = [
  {
    ...
    "indicationsNotes": "Tumor-informed MRD assay for multiple common and rare solid tumors; Quest/Resolution MRD platform, FDA Breakthrough Device designation for Stage II CRC (Aug 2025). NEJM validation (Apr 2025): MRD detected recurrence median 1.4 months post-surgery vs 6.1 months for imaging.",
    "sensitivity": 95.0,
    ...
    "leadTimeVsImaging": 42.0,
    "leadTimeVsImagingCitations": "https://doi.org/10.1056/NEJMoa2502029",
    "leadTimeVsImagingNotes": "NEJM Apr 2025: ctDNA detected at median 1.4 months (42 days) post-surgery vs 6.1 months for imaging-based recurrence detection in CRC.",
    "tat": 30.0,
    ...
    "fdaStatus": "CLIA LDT (Quest Diagnostics); FDA Breakthrough Device designation for stage II colorectal cancer (Aug 2025). ASCO GI 2026 data presented.",
    ...
    "numPublications": 18,
    "numPublicationsNotes": "Includes NEJM Apr 2025 landmark publication demonstrating ctDNA detection at median 1.4 months post-surgery vs 6.1 months for imaging-based recurrence detection. ASCO GI 2026: Abstract 26 (Tie et al.) — reproducibility and clinical concordance in resected CRC from DYNAMIC trials; Abstract 30 (Christenson et al.) — ctDNA monitoring during total neoadjuvant treatment for locally advanced rectal cancer.",
    "numPublicationsCitations": "https://doi.org/10.1056/NEJMoa2502029",
    ...
    }},
  {
    ...
    "indicationsNotes": "Personalis NeXT Personal Dx tumor-informed MRD assay. Medicare-covered for early-stage breast cancer recurrence monitoring ($4,266/test, effective Oct 7 2025); clinical data in CRC, NSCLC (TRACERx: 431 pts, 5x relapse risk, Cell Dec 2025), and cervical cancer (CALLA trial: detection 16 months ahead of imaging). PREDICT-DNA study (TBCRC 040, JCO March 2026, n=227 TNBC/HER2+ breast cancer): ctDNA post-neoadjuvant therapy associated with 4-9x relapse risk; ctDNA strongest independent prognostic factor over pCR, nodal status, and grade.",
    "sensitivity": 100,
    ...
    "lod": "1.67 ppm",
    "lod95": "3.45 ppm",
    "lod95Citations": "https://www.personalis.com/for-clinicians/next-personal-dx/",
    "lodCitations": "Northcott et al. Oncotarget 2024; https://www.personalis.com/for-clinicians/next-personal-dx/",
    ...
    "bloodVolume": 20.0,
    "bloodVolumeCitations": "https://www.personalis.com/for-clinicians/next-personal-dx/",
    ...
    "totalParticipants": 1151,
    "totalParticipantsNotes": "493 (analytical validation) + 431 (TRACERx NSCLC) + 227 (PREDICT-DNA TBCRC 040)",
    "numPublications": 8,
    "numPublicationsPlus": true,
    "numPublicationsNotes": "Includes TRACERx NSCLC (Cell Dec 2025), CALLA cervical cancer, immunotherapy monitoring (npj Precision Oncology Feb 2026)"
  ,
    "medicareCoverage": {
      "status": "COVERED",
      "policyType": "LCD",
    ...
    }},
  {
    "id": "mrd-4",
    "sampleCategory": "Blood/Plasma",
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://pmc.ncbi.nlm.nih.gov/articles/PMC11994999/",
    "name": "Pathlight",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://cms.neogenomics.com/sites/default/files/literature/S",
    "name": "RaDaR ST",
    "vendor": "NeoGenomics",
    "approach": "Tumor-informed",
    ...
    "cptCodesNotes": "Contact vendor for current billing guidance.",
    "clinicalAvailability": "Clinical LDT – shipping",
    "clinicalTrials": "ISLB 2025 bridging study (166 pts, 15 solid tumor types, 97% concordance with RaDaR 1.0); SABCS 2025: CLEVER 5-year breast cancer data; SURVIVE HERoes Phase III breast cancer study",
    ...
    "numPublications": 12,
    "numPublicationsPlus": true,
    "numPublicationsNotes": "Includes SABCS 2025 CLEVER 5-year breast cancer study and SURVIVE HERoes Phase III data.",
    "vendorRequestedChanges": "2026-01-27: UHC Policy Review - Updated UHC coverage status per 2026 Molecular Oncology Testing policy - solid tumor MRD listed as Unproven/Not Medically Necessary.",
    ...
    }},
  {
    ...
    "sampleCategory": "Blood/Plasma",
    "sampleVolumeMl": 20,
    "sampleVolumeCitations": "https://www.guardantcomplete.com/hcp/solutions/guardant-reveal",
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCollectionNotes": "Commonly collected as two 10 mL Streck cfDNA tubes (≈20 mL).",
    "sampleCitations": "https://www.guardantcomplete.com/hcp/solutions/guardant-reveal",
    "name": "Reveal MRD",
    ...
    "indicationsNotes": "Guardant Reveal MRD tumor-naïve ctDNA test for early-stage cancer MRD detection and recurrence monitoring after curative-intent treatment. Medicare coverage for CRC; breast and NSCLC coverage expanding. JCO Feb 2026 (Sinicrope et al., N0147 trial, n>2,000 stage III colon cancer, median follow-up 6.1 years): 4-6x higher recurrence risk identification for ctDNA-positive patients; even low-risk subgroups had >6x event rate if ctDNA detected; ~20% had detectable ctDNA post-surgery.",
    "sensitivity": 81.0,
    "sensitivityCitations": "https://pmc.ncbi.nlm.nih.gov/articles/PMC11443202/ | https://pmc.ncbi.nlm.nih.gov/articles/PMC12866954/",
    ...
    "initialTat": 7.0,
    "initialTatCitations": "https://www.guardantcomplete.com/hcp/solutions/guardant-reveal",
    "initialTatNotes": "Vendor-reported 7-day median TAT.",
    "followUpTat": 7.0,
    "followUpTatCitations": "https://www.guardantcomplete.com/hcp/solutions/guardant-reveal",
    "followUpTatNotes": "Vendor-reported 7-day median TAT.",
    "bloodVolume": 20.0,
    "bloodVolumeCitations": "https://www.guardantcomplete.com/hcp/solutions/guardant-reveal",
    "bloodVolumeNotes": "Commonly collected as two 10 mL Streck cfDNA tubes (≈20 mL).",
    "tat": 7.0,
    "tatCitations": "https://www.guardantcomplete.com/hcp/solutions/guardant-reveal",
    ...
    "commercialPayersNotes": "BCBS Louisiana: first commercial payer (July 2023). Geisinger: added 2023. Blue Shield CA: conditional coverage for stage III/IV solid tumors seeking treatment (2026). UnitedHealthcare: explicitly NOT covered per Molecular Oncology Testing policy - all MRD tests listed as unproven. Carelon (formerly AIM Specialty Health): Conditional/restricted (UC0126) — anticipated benefit must outweigh potential harms; must be supported by treatment guidelines and current clinical literature.",
  ...
  },
  {
    ...
    "lod": "~0.01% VAF",
    "lodCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    ...
    "variantsTrackedCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    "initialTat": 28.0,
    "initialTatNotes": "Baseline tumor/normal sequencing and panel design typically require ~3–4 weeks.",
    "initialTatCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    "followUpTat": 9.0,
    "followUpTatNotes": "Longitudinal MRD blood draws generally reported within ~7–10 days.",
    "followUpTatCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    "bloodVolume": 20.0,
    "bloodVolumeNotes": "Commonly two Streck cfDNA tubes (~10 mL each) for monitoring; tissue + matched normal required at baseline",
    "bloodVolumeCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    "tat": 28.0,
    ...
    "vendorRequestedChanges": "2026-01-27: UHC Policy Review - Updated UHC coverage status per 2026 Molecular Oncology Testing policy - solid tumor MRD listed as Unproven/Not Medically Necessary.",
    "financialAssistance": "Financial Assistance: $0–$149 based on income (apply at care.natera.com). Prompt-Pay Cash: $349 if paid within 60 days. Interest-free 12-month payment plans. Contact: 650-489-9050 or signaterapc@natera.com",
    "medicareCoverage": {
      "status": "COVERED",
      "policyType": "LCD",
      "policyNumber": "L38779",
  ...
  },
  {
    ...
    "validationCohortSize": 80,
    "validationCohortStudy": "GALAXY (CIRCULATE-Japan) CRC subset (n=80 resected stage II-III CRC)",
    "smallSampleWarning": true,
    "numPublications": 3,
    "numPublicationsPlus": true,
    "vendorRequestedChanges": "2026-01-27: UHC Policy Review - Updated UHC coverage status per 2026 Molecular Oncology Testing policy - solid tumor MRD listed as Unproven/Not Medically Necessary.",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://assets.ctfassets.net/w98cd481qyp0/1iqyMQwcJ0jGCYhUxc",
  ...
  },
  {
    ...
    "sensitivity": 91,
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/38811314/ | Nordentoft I et al. Eur Urol 2024;86(4):301-311; EAU25 Abstract A0162",
    ...
    "leadTimeVsImaging": 131,
    "leadTimeVsImagingCitations": "https://pubmed.ncbi.nlm.nih.gov/38811314/ | Nordentoft I et al. Eur Urol 2024 (MIBC); https://pubmed.ncbi.nlm.nih.gov/39316995/ | Frydendahl A et al. Eur J Cancer 2024 (CRC: 8.7 months)",
    "leadTimeVsImagingNotes": "MIBC: 131-day median lead time over imaging (Nordentoft 2024). CRC: 8.7-month median lead time before radiological recurrence (Frydendahl 2024).",
    "specificity": 92,
    "specificityCitations": "https://pubmed.ncbi.nlm.nih.gov/38811314/ | Nordentoft I et al. Eur Urol 2024;86(4):301-311",
    "specificityNotes": "92% specificity at 91% sensitivity in urothelial carcinoma (Nordentoft 2024). TOMBOLA trial (EAU25) showed 88% specificity at 6-month milestone vs 62% for ddPCR. WGS-based approach detected recurrence 93 days before imaging.",
    "lod": "0.001% TF",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://pmc.ncbi.nlm.nih.gov/articles/PMC12068320/",
    ...
    "leadTimeVsImagingCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/ | Foresight CLARITY product page",
    ...
    }},
  {
    ...
    "lod": "80 ppm",
    "lod95": null,
    "lodCitations": "https://www.invitae.com/us/providers/test-catalog/personalized-cancer-monitoring | Labcorp Invitae PCM specifications",
    ...
    "cptCodes": "0306U, 0307U",
    "medicareRate": 3878.45,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "Invitae PCM PLA codes (BCBSM EI status Jan 2025). 0306U=baseline tissue profiling, 0307U=plasma MRD monitoring.",
    ...
    }},
  {
    ...
    "sampleCategory": "Blood/Plasma",
    "sampleVolumeMl": 20,
    "sampleTubeType": "PAXgene Blood ccfDNA Tube",
    "sampleTubeCount": 2,
    "sampleCollectionNotes": "Approximately 20mL whole blood; plasma and buffy coat analyzed separately.",
    "sampleCitations": "https://jdos.nicholsinstitute.com/dos/HoagHospital/test/10835 | https://www.carislifesciences.com/products-and-services/assure/",
    "name": "Caris Assure",
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "Caris Assure PLA code (BCBSM EI status Jan 2025). Tumor-naïve WES/WTS MRD assay.",
    "sensitivity": 93.8,
    ...
    "performanceNotes": "For MRD detection, disease-free survival of patients predicted to have an event (MRD-positive) was significantly shorter than those predicted MRD-negative (HR=33.4, p<0.005). For monitoring, HR=4.39, p=0.008. Caris Assure MCED validation (Nature Sci Reports Jul 2025): 83–96% sensitivity across cancer types. Uses tumor-naïve approach - no prior tissue profiling required.",
    "performanceCitations": "https://www.nature.com/articles/s41598-025-08986-0 | Nature Scientific Reports Jul 2025 (Caris Assure MCED validation)",
    "fdaStatus": "CLIA LDT",
    "reimbursement": "Coverage Varies",
    ...
    "vendorRequestedChanges": "2026-01-27: UHC Policy Review - Updated UHC coverage status per 2026 Molecular Oncology Testing policy - solid tumor MRD listed as Unproven/Not Medically Necessary. 2026-01-30: Streck tube correction - sampleTubeType changed from 'Streck cfDNA BCT' to 'PAXgene Blood ccfDNA Tube' per Lu Zhang (Streck) review.",
    ...
    }},
  {
    ...
    "variantsTracked": "Patient-specific clonal sequences",
    "variantsTrackedNotes": "Patient-specific clonal sequence tracking: B-cell receptor (IgH, IgK, IgL) sequences and/or T-cell receptor (TCRβ, TCRγ) sequences. Tracks patient-specific clonotype(s) identified at diagnosis.",
    "variantsTrackedCitations": "https://www.clonoseq.com/wp-content/uploads/2021/11/NP-US-cSEQ-0006-3_clonoSEQ_ReportsWalkthrough_WEB.pdf",
    "initialTat": 14,
    ...
    "bloodVolume": ">2mL",
    "bloodVolumeNotes": ">2mL in EDTA for cellular assessment in all diseases, ~10mL in Streck for cfDNA assessment in DLBCL only.",
    ...
    "fdaStatus": "FDA-cleared in vitro diagnostic (IVD) test service in bone marrow for multiple myeloma or B-cell acute lymphoblastic leukemia (B-ALL) and blood or bone marrow for chronic lymphocytic leukemia (CLL). De Novo cleared Sept 2018 (MM, B-ALL), expanded Aug 2020 (CLL). CE-IVDR Class C certified (Aug 2024) - first IVDR-certified MRD test for lymphoid malignancies in EU.",
    ...
    "reimbursement": "Medicare (national coverage)",
    "reimbursementNote": "clonoSEQ is nationally covered by Medicare for multiple myeloma, ALL, CLL, DLBCL, and MCL via MolDX program. Medicare CLFS rate: $2,007 per test (PLA 0364U); episode pricing $8,029 across all covered indications. Positive coverage from major commercial insurers for MM and ALL. 90% of patients pay $0 for testing.",
    ...
    "clinicalTrials": "Incorporated into over 190 clinical trials, with more than 51,000 patients evaluated across clinical and real-world settings. Key trials include ALCYONE (706 pts, transplant-ineligible NDMM), POLLUX (569 pts, R/R MM), MASTER (daratumumab-KRd MRD-guided discontinuation), DETERMINATION (RVd ± ASCT), multiple ALL and CLL studies. Used in 25 of 28 NCCN cancer centers.",
    ...
    "numPublications": 250,
    "numPublicationsPlus": true,
    "numPublicationsNotes": "Over 250 peer-reviewed publications including validation studies in MM, ALL, CLL, lymphomas. Clinical data incorporated into FDA drug approvals and NCCN guidelines.",
    "clinicalSettings": ["Neoadjuvant", "Post-Adjuvant", "Surveillance"],
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-de",
    ...
    "sensitivityCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/ | George M, et al. ASCO 2025 poster",
    "specificity": 100,
    ...
    "specificityCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/ | George M, et al. ASCO 2025 poster",
    ...
    "lod": "1 ppm",
    "lod95": "1 ppm",
    "lod95Citations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    ...
    "leadTimeVsImagingCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/ | George M, et al. ASCO 2025 poster",
    "requiresTumorTissue": "Yes",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://www.natera.com/oncology/latitude-tissue-free-mrd/",
    "name": "Latitude",
    "vendor": "Natera",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0334282",
  ...
  },
  {
    ...
    "sampleCitations": "https://liqomics.com/en/downloads/submission-information-en.pdf",
    "name": "LymphoVista",
    "vendor": "LIQOMICS",
  ...
  // Merged into MRD category - original IDs preserved (trm-*)
  // ============================================
  {
    "id": "trm-1",
    "sampleCategory": "Blood/Plasma",
    ...
    "leadTimeVsImagingCitations": "https://guardanthealth.com/products/tests-for-patients-with-early-and-advanced-stage-cancer/ | Guardant Health Response product page",
    "lod": "~0.1–0.2% VAF",
    ...
    "commercialPayers": [],
    "commercialPayersNotes": "Aetna: Not covered (CPB 0352). Blue Cross NC: Conditional/restricted — Must be for treatment selection, not screening or general monitoring. Excellus BCBS (NY): Conditional/restricted — Must direct targeted therapy.",
    "commercialPayersNonCoverage": ["Aetna"],
    "commercialPayersNonCoverageNotes": "Aetna: Not covered (CPB 0352).",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/",
    ...
    "lodCitations": "https://www.natera.com/oncology/signatera-advanced-cancer-detection/ | Natera Signatera clinical evidence",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://www.tempus.com/wp-content/uploads/2024/01/Tempus-LS_xM-MRD_Test-Information_12.23-v4.pdf",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://cdn.prod.website-files.com/676903c0e34284138d6e0066/",
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "Northstar Response PLA code (BCBSM EI status Jan 2025). Methylation-based therapy response monitoring.",
    "tat": "10 days",
    ...
    }},
  {
    ...
    "sampleCitations": "https://jdos.nicholsinstitute.com/dos/HoagHospital/test/10835 | https://www.carislifesciences.com/",
    "name": "Caris Assure",
    "vendor": "Caris Life Sciences",
    ...
    "cptCodes": "0485U",
    "cptCodesNotes": "Caris Assure PLA code (BCBSM EI status Jan 2025). WES/WTS liquid biopsy.",
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "Caris Assure PLA code (BCBSM EI status Jan 2025). Tumor-naïve WES/WTS liquid biopsy.",
    "clinicalAvailability": "Commercially available in US since late 2022",
    "availableRegions": ["US"],
    "tat": "10-14 days",
    ...
    "vendorRequestedChanges": "2026-01-30: Streck tube correction - sampleTubeType changed from 'Streck cfDNA BCT' to 'PAXgene Blood ccfDNA Tube' per Lu Zhang (Streck) review.",
    "financialAssistance": "Financial Assistance Program available",
    "medicareCoverage": {
      "status": "COVERED",
      "policyType": "LCD",
    ...
    }},
  {
    ...
    "methodCitations": "https://guardanthealth.com/products/tests-for-patients-with-early-and-advanced-stage-cancer/ | AACR 2025 Tumor Fraction Update; https://pubmed.ncbi.nlm.nih.gov/38662357/ | Nakamura Y et al. Clin Cancer Res 2024",
    "cancerTypes": [
    ...
    "lodCitations": "https://guardanthealth.com/products/tests-for-patients-with-early-and-advanced-stage-cancer/ | Guardant Reveal product page; AACR 2025",
    "leadTimeVsImaging": null,
    ...
    "clinicalTrialsCitations": "https://guardanthealth.com/products/tests-for-patients-with-early-and-advanced-stage-cancer/ | AACR 2025 Tumor Fraction Update presentation",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://www.tempus.com/oncology/genomic-profiling/xf/",
    "name": "xM for TRM",
    "vendor": "Tempus AI",
    "approach": "Tumor-naïve",
    "requiresTumorTissue": "No",
  ...
  },
  {
    ...
    "sampleVolumeMl": null,
    "sampleTubeType": null,
    "sampleTubeCount": null,
    "sampleCollectionNotes": null,
    "sampleCitations": null,
    "name": "Precise MRD",
    "vendor": "Myriad Genetics",
    "approach": "Tumor-informed",
    "method": "Tumor-informed WGS-based MRD assay: whole-genome sequencing of tumor creates a personalized panel tracking up to 1,000 tumor-specific variants with single-read error correction for ultrasensitive ctDNA detection.",
    "cancerTypes": ["Breast"],
    "cancerTypesNotes": "Limited commercial launch for breast cancer (March 2026). CRC and renal cancer expansion planned later 2026.",
    "indicationsNotes": null,
    "sensitivity": null,
    "sensitivityCitations": null,
    "sensitivityNotes": "Clinical data published in The Lancet Oncology; commercial sensitivity/specificity not yet separately reported.",
    "sensitivityStagesReported": null,
    "stageIISensitivity": null,
    "stageIISensitivityNotes": null,
    "stageIIISensitivity": null,
    "stageIIISensitivityNotes": null,
    "specificity": null,
    "specificityCitations": null,
    "specificityNotes": null,
    "lod": "1 ppm",
    "lod95": null,
    "lodCitations": null,
    "lodNotes": "Detection down to 1 part per million (0.0001% tumor fraction). 94% of patients tested at baseline had ctDNA levels below 100 ppm.",
    "leadTimeVsImaging": null,
    "leadTimeVsImagingCitations": null,
    "leadTimeVsImagingNotes": null,
    "requiresTumorTissue": "Yes",
    "requiresTumorTissueNotes": null,
    "requiresMatchedNormal": null,
    "requiresMatchedNormalNotes": null,
    "variantsTracked": "1000",
    "variantsTrackedCitations": null,
    "variantsTrackedNotes": null,
    "initialTat": null,
    "initialTatCitations": null,
    "initialTatNotes": null,
    "followUpTat": null,
    "followUpTatCitations": null,
    "followUpTatNotes": null,
    "bloodVolume": null,
    "bloodVolumeCitations": null,
    "bloodVolumeNotes": null,
    "tat": null,
    "tatCitations": null,
    "tatNotes": null,
    "fdaStatus": "CLIA LDT",
    ...
    "commercialPayers": [],
    "commercialPayersNotes": null,
    "cptCodes": null,
    "clinicalAvailability": "Limited commercial launch — select community oncology practices (March 2026)",
    "availableRegions": ["US"],
    "clinicalTrials": null,
    "clinicalSettings": ["Post-Surgery", "Neoadjuvant", "Surveillance"],
    "clinicalSettingsNotes": null,
    "totalParticipants": null,
    "numPublications": 1,
    "numPublicationsNotes": "Lancet Oncology 2026",
    "numPublicationsPlus": false,
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": true,
    "dataSourceNotes": "Launched March 2, 2026. Source: Myriad press release."
  },
  // ============================================
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://inocras.com/mrdvision/",
    "name": "MRDVision",
    "vendor": "Inocras",
    "category": "MRD",
    ...
    }},
  {
    ...
    "name": "Bladder EpiCheck",
    "vendor": "Nucleix",
    "category": "MRD",
    "dateAdded": "Jan 14, 2026",
    "approach": "Tumor-naïve",
    "method": "PCR-based 15-marker DNA methylation urine test",
    "methodCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf20/K203245.pdf",
    "cancerTypes": ["Bladder (NMIBC)"],
    "cancerTypesNotes": "Specifically designed for non-muscle invasive bladder cancer (NMIBC) surveillance",
    "sensitivity": 67,
    "sensitivityNotes": "Overall sensitivity 67% (95% CI 58-74%); High-grade sensitivity 77% (65-85%) per US pivotal study (n=449)",
    "sensitivityCitations": "https://journals.sagepub.com/doi/10.1177/23523735241304348",
    "specificity": 84,
    "specificityNotes": "Overall specificity 84% (80-88%) per US pivotal study",
    "specificityCitations": "https://journals.sagepub.com/doi/10.1177/23523735241304348",
    "ppv": 65,
    "ppvNotes": "PPV 65% (57-73%) per US pivotal study",
    "ppvCitations": "https://journals.sagepub.com/doi/10.1177/23523735241304348",
    "npv": 85,
    "npvNotes": "Overall NPV 85% (81-89%); High-grade NPV 95% (92-97%) per US pivotal study",
    "npvCitations": "https://journals.sagepub.com/doi/10.1177/23523735241304348",
    "lod": "DNA methylation threshold",
    "lodNotes": "15 proprietary methylation biomarkers analyzed",
    "lodCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf20/K203245.pdf",
    "requiresTumorTissue": "No",
    "requiresTumorTissueNotes": "Tumor-naïve approach using urine methylation markers; no tumor tissue required",
    "requiresMatchedNormal": "No",
    "variantsTracked": "15 DNA methylation markers",
    "initialTat": null,
    "initialTatNotes": "Same-day testing available",
    "followUpTat": null,
    "followUpTatNotes": "Routine surveillance testing",
    "tatNotes": "Rapid turnaround; specific times not published",
    "sampleVolumeMl": 10,
    "sampleCollectionNotes": "Voided urine collected prior to cystoscopy; minimum 10mL required",
    "sampleCitations": "https://nucleix.com/bladder-epicheck-5/",
    "fdaStatus": "FDA 510(k) Cleared",
    "fdaStatusNotes": "510(k) cleared May 2023 (K203245) for monitoring NMIBC recurrence in conjunction with cystoscopy",
    "fdaStatusCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf20/K203245.pdf",
    "reimbursement": "Coverage emerging",
    "reimbursementNotes": "CE-marked in Europe since 2016; US coverage landscape developing; Netherlands reimbursement achieved 2023",
    "cptCodes": "",
    "clinicalAvailability": "Commercially available in US and Europe",
    "clinicalAvailabilityNotes": "Available through CLIA-certified laboratories in US; established in European markets",
    "availableRegions": ["US", "EU"],
    "clinicalTrials": "NCT02700464",
    "clinicalTrialsCitations": "https://clinicaltrials.gov/study/NCT02700464",
    "clinicalSettings": ["Surveillance"],
    "clinicalSettingsNotes": "Primary use in NMIBC surveillance in conjunction with cystoscopy; adjunctive test to reduce unnecessary cystoscopy procedures",
    "totalParticipants": 449,
    "totalParticipantsNotes": "US pivotal study with 449 patients; additional European pivotal study with 353 patients",
    "totalParticipantsCitations": "https://journals.sagepub.com/doi/10.1177/23523735241304348",
    "validationCohortSize": 449,
    "validationCohortStudy": "US pivotal study (Technology in Cancer Research & Treatment 2024; n=449)",
    "numPublications": 21,
    "numPublicationsNotes": "7 unique clinical studies on NMIBC surveillance per 2023 literature review; extensive European clinical data",
    "numPublicationsCitations": "https://www.urologytimes.com/view/urine-based-test-demonstrates-consistent-efficacy-in-nmibc-surveillance",
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": false,
    "regulatoryStatusNotes": "FDA 510(k) cleared device, not an LDT",
    "vendorVerified": false,
    "technologyDifferentiator": "Non-invasive urine-based methylation test for bladder cancer surveillance; reduces need for invasive cystoscopy procedures; particularly effective for high-grade disease detection",
    "medicareCoverage": {
      "status": "PENDING_LCD",
      "policyType": "LCD",
      "policyNumber": "L38576",
      "policyName": "MolDX: Prognostic and Predictive Molecular Classifiers for Bladder Cancer",
      "coveredIndications": [],
      "reimbursementRate": null,
      "cptCode": null,
  ...
  // K-4CARE MRD - Added January 2026 (Vendor Submission - David Schlesinger, Gene Solutions)
  {
    ...
    "approach": "Tumor-informed",
    "method": "CGP-informed personalized ctDNA tracking using bespoke multiplex PCR with ultra-deep sequencing (100,000X) for MRD detection",
    "methodCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "cancerTypes": ["Lung", "Colorectal", "Breast", "Liver", "Gastric", "Ovarian"],
    "cancerTypesNotes": "MRD monitoring available for 6 selected cancer types using tumor-derived mutations",
    "sensitivity": 79,
    "sensitivityNotes": "79% ctDNA detection rate in liquid biopsy when using CGP-informed mutations for personalized tracking",
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "specificity": 99,
    "specificityNotes": ">99% specificity for somatic variant detection",
    "specificityCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "specificityPlus": true,
    "requiresTumorTissue": "Yes",
    "requiresTumorTissueNotes": "FFPE tumor tissue required for initial CGP profiling to identify mutations for personalized MRD tracking",
    "requiresMatchedNormal": "Yes",
    "requiresMatchedNormalNotes": "Peripheral blood WBC sample used as matched normal to distinguish somatic from germline variants",
    "clinicalSettings": ["Post-Surgery", "Surveillance"],
    "clinicalSettingsNotes": "Longitudinal ctDNA-MRD monitoring for treatment response",
    "fdaStatus": "Not FDA cleared",
    "fdaStatusNotes": "US validation underway with Pangea Laboratory; available as LDT in Asian markets",
    "reimbursement": "Not covered",
    "reimbursementNote": "No US coverage",
    "clinicalAvailability": "Commercial in Asian markets; US launch planned",
    "availableRegions": ["Singapore", "Vietnam"],
    "numPublications": 1,
    "numPublicationsCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "numPublicationsNotes": "Frontiers in Molecular Biosciences (2024) - analytical validation",
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": true,
  ...
  // EasyM - Added January 2026 (Vendor Submission - Jenna Kerry, Rapid Novor)
  {
    "id": "mrd-29",
    "sampleCategory": "Blood/Plasma",
    "name": "EasyM",
    "vendor": "Rapid Novor",
    "approach": "Tumor-naive",
    "method": "Clonotypic peptides mass spectrometry: de novo amino acid sequencing of patient's M-protein from baseline serum, followed by targeted MS/MS parallel reaction monitoring (PRM) to quantify unique clonotypic peptides in follow-up samples.",
    "methodCitations": "https://doi.org/10.1158/1078-0432.CCR-21-0649",
    "cancerTypes": ["Multiple Myeloma"],
    "cancerTypesNotes": "IgG myeloma validated; non-IgG isotypes and light chain disease validation ongoing. Not suitable for non-secretory myeloma.",
    "sampleVolumeMl": 0.1,
    "sampleTubeType": "Gold top SST (serum separator tube)",
    "sampleTubeCount": 1,
    "sampleCollectionNotes": "Serum preferred. Requires baseline sample with measurable M-protein (≥0.5 g/dL by SPEP) for initial sequencing.",
    "sampleCitations": "https://www.easym.com/easym-technology-mrd-blood-test-myeloma/",
    "requiresTumorTissue": "No",
    ...
    "followUpTat": 10,
    "followUpTatCitations": "https://www.easym.com/easym-technology-mrd-blood-test-myeloma/",
    "followUpTatNotes": "MRD monitoring results within 5-10 working days.",
    "tat": 10,
    "tatCitations": "https://www.easym.com/easym-technology-mrd-blood-test-myeloma/",
    "tatNotes": "5-10 working days for both initial sequencing and follow-up monitoring.",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA-certified LDT (January 2023). Available in all US states except NY. Not FDA-cleared.",
    "reimbursement": "Not covered",
    "reimbursementNote": "Not covered by Medicare or commercial insurance. Self-pay or clinical trial access.",
    "clinicalAvailability": "Clinical LDT – Central lab",
    "clinicalAvailabilityNotes": "Samples shipped to Rapid Novor lab in Kitchener, Ontario, Canada.",
    "availableRegions": ["US", "Canada"],
    "clinicalTrials": "MCRN-001; PMCC prospective study (ongoing); MM19/MM21 Australian trials",
    ...
    "clinicalSettings": ["Surveillance"],
    "clinicalSettingsNotes": "MRD monitoring during complete response. M-protein doubling over 6 months predicted relapse. Detects relapse 2-38 months earlier than IFE/SPEP.",
    "leadTimeVsImaging": 300,
    "leadTimeVsImagingCitations": "https://doi.org/10.1158/1078-0432.CCR-21-0649",
...
export const ecdTestData = [
    ...
    }},
  {
    ...
    "sensitivityType": "observed (case-control)",
    "incidenceAdjustedSensitivity": 48.1,
    "incidenceAdjustedSensitivityNotes": "Calculated IAS: CCGA-3 cancer-type-specific observed sensitivities (Table S5) weighted by SEER 2021 incidence proportions across 21 cancer types. Lower than observed sensitivity (51.5%) because high-incidence cancers (breast 30.5%, prostate 11.2%) have low detection rates. See scripts/calculate-ias.js for full methodology. Note: IAS values are not directly comparable across tests with different specificities. Galleri operates at 99.5% specificity.",
    "incidenceAdjustedSensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/34176681/ | https://seer.cancer.gov/statfacts/",
    "cancerTypeSensitivity": [
      { "cancerType": "Anus", "stageI": { "detected": 1, "total": 4 }, "stageII": { "detected": 3, "total": 4 }, "stageIII": { "detected": 13, "total": 13 }, "stageIV": { "detected": 1, "total": 1 }, "overall": { "detected": 18, "total": 22 } },
      { "cancerType": "Bladder", "stageI": { "detected": 2, "total": 6 }, "stageII": { "detected": 1, "total": 11 }, "stageIII": { "detected": 3, "total": 4 }, "stageIV": { "detected": 2, "total": 2 }, "overall": { "detected": 8, "total": 23 } },
      { "cancerType": "Breast", "stageI": { "detected": 7, "total": 265 }, "stageII": { "detected": 86, "total": 181 }, "stageIII": { "detected": 47, "total": 55 }, "stageIV": { "detected": 20, "total": 22 }, "overall": { "detected": 160, "total": 524 } },
      { "cancerType": "Cervix", "stageI": { "detected": 7, "total": 12 }, "stageII": { "detected": 5, "total": 5 }, "stageIII": { "detected": 7, "total": 7 }, "stageIV": { "detected": 1, "total": 1 }, "overall": { "detected": 20, "total": 25 } },
      { "cancerType": "Colon/Rectum", "stageI": { "detected": 13, "total": 30 }, "stageII": { "detected": 34, "total": 40 }, "stageIII": { "detected": 58, "total": 66 }, "stageIV": { "detected": 61, "total": 64 }, "overall": { "detected": 169, "total": 206 } },
      { "cancerType": "Esophagus", "stageI": { "detected": 1, "total": 8 }, "stageII": { "detected": 11, "total": 17 }, "stageIII": { "detected": 32, "total": 34 }, "stageIV": { "detected": 40, "total": 40 }, "overall": { "detected": 85, "total": 100 } },
      { "cancerType": "Gallbladder", "stageI": { "detected": 0, "total": 2 }, "stageII": { "detected": 1, "total": 3 }, "stageIII": { "detected": 3, "total": 4 }, "stageIV": { "detected": 8, "total": 8 }, "overall": { "detected": 12, "total": 17 } },
      { "cancerType": "Head and Neck", "stageI": { "detected": 12, "total": 19 }, "stageII": { "detected": 14, "total": 17 }, "stageIII": { "detected": 16, "total": 19 }, "stageIV": { "detected": 48, "total": 50 }, "overall": { "detected": 90, "total": 105 } },
      { "cancerType": "Kidney", "stageI": { "detected": 3, "total": 61 }, "stageII": { "detected": 2, "total": 9 }, "stageIII": { "detected": 1, "total": 7 }, "stageIV": { "detected": 12, "total": 22 }, "overall": { "detected": 18, "total": 99 } },
      { "cancerType": "Liver/Bile-duct", "stageI": { "detected": 6, "total": 6 }, "stageII": { "detected": 7, "total": 10 }, "stageIII": { "detected": 9, "total": 9 }, "stageIV": { "detected": 20, "total": 20 }, "overall": { "detected": 43, "total": 46 } },
      { "cancerType": "Lung", "stageI": { "detected": 21, "total": 96 }, "stageII": { "detected": 35, "total": 44 }, "stageIII": { "detected": 107, "total": 118 }, "stageIV": { "detected": 138, "total": 145 }, "overall": { "detected": 302, "total": 404 } },
      { "cancerType": "Lymphoma", "stageI": { "detected": 9, "total": 33 }, "stageII": { "detected": 28, "total": 48 }, "stageIII": { "detected": 33, "total": 46 }, "stageIV": { "detected": 28, "total": 46 }, "overall": { "detected": 98, "total": 174 } },
      { "cancerType": "Lymphoid Leukemia", "overall": { "detected": 21, "total": 51 } },
      { "cancerType": "Melanoma", "stageI": { "detected": 0, "total": 2 }, "stageII": { "detected": 0, "total": 2 }, "stageIII": { "detected": 0, "total": 3 }, "stageIV": { "detected": 6, "total": 6 }, "overall": { "detected": 6, "total": 13 } },
      { "cancerType": "Myeloid Neoplasm", "overall": { "detected": 2, "total": 10 } },
      { "cancerType": "Ovary", "stageI": { "detected": 5, "total": 10 }, "stageII": { "detected": 4, "total": 5 }, "stageIII": { "detected": 27, "total": 31 }, "stageIV": { "detected": 18, "total": 19 }, "overall": { "detected": 54, "total": 65 } },
      { "cancerType": "Pancreas", "stageI": { "detected": 13, "total": 21 }, "stageII": { "detected": 12, "total": 20 }, "stageIII": { "detected": 18, "total": 21 }, "stageIV": { "detected": 70, "total": 73 }, "overall": { "detected": 113, "total": 135 } },
      { "cancerType": "Plasma Cell Neoplasm", "stageI": { "detected": 11, "total": 17 }, "stageII": { "detected": 14, "total": 16 }, "stageIII": { "detected": 9, "total": 14 }, "overall": { "detected": 34, "total": 47 } },
      { "cancerType": "Prostate", "stageI": { "detected": 3, "total": 95 }, "stageII": { "detected": 12, "total": 243 }, "stageIII": { "detected": 7, "total": 50 }, "stageIV": { "detected": 25, "total": 30 }, "overall": { "detected": 47, "total": 420 } },
      { "cancerType": "Sarcoma", "stageI": { "detected": 4, "total": 10 }, "stageII": { "detected": 2, "total": 2 }, "stageIII": { "detected": 5, "total": 10 }, "stageIV": { "detected": 6, "total": 7 }, "overall": { "detected": 18, "total": 30 } },
      { "cancerType": "Stomach", "stageI": { "detected": 1, "total": 6 }, "stageII": { "detected": 3, "total": 6 }, "stageIII": { "detected": 4, "total": 5 }, "stageIV": { "detected": 12, "total": 12 }, "overall": { "detected": 20, "total": 30 } },
      { "cancerType": "Thyroid", "stageI": { "detected": 0, "total": 11 }, "stageII": { "detected": 0, "total": 1 }, "stageIII": { "detected": 0, "total": 1 }, "stageIV": { "detected": 0, "total": 1 }, "overall": { "detected": 0, "total": 14 } },
      { "cancerType": "Uterus", "stageI": { "detected": 20, "total": 120 }, "stageII": { "detected": 3, "total": 10 }, "stageIII": { "detected": 17, "total": 23 }, "stageIV": { "detected": 4, "total": 4 }, "overall": { "detected": 44, "total": 157 } }
    ],
    "cancerTypeSensitivityCitations": "Klein EA et al. Ann Oncol. 2021;32(9):1167-1177. CCGA3 Table S5.",
    "perCancerEarlyStageSensitivity": {"Liver":{"pct":85.0,"n":16},"Ovary":{"pct":65.0,"n":15},"Pancreas":{"pct":61.0,"n":41},"Head and Neck":{"pct":56.0,"n":36},"Multiple Myeloma":{"pct":55.0,"n":33},"Lymphoma":{"pct":40.0,"n":81},"Esophagus":{"pct":38.5,"n":25},"Gastric":{"pct":35.0,"n":12},"Colon/Rectum":{"pct":33.0,"n":70},"Cervix":{"pct":30.0,"n":17},"Sarcoma":{"pct":28.0,"n":12},"Lung":{"pct":24.0,"n":140},"Endometrial":{"pct":18.0,"n":130},"Bladder":{"pct":15.0,"n":17},"Melanoma":{"pct":10.0,"n":4},"Breast":{"pct":8.5,"n":446},"Kidney":{"pct":8.0,"n":70},"Thyroid":{"pct":5.0,"n":12},"Prostate":{"pct":4.2,"n":338}},
    "perCancerEarlyStageSensitivitySource": "CCGA3 Stage I-II (Klein et al., Annals of Oncology, 2021)",
    ...
    "specificityNotes": "99.5% specificity (0.5% false positive rate). In a screening population of 100,000 with ~1% cancer prevalence, expect ~495 false positives. Lower false positive rate than most MCED competitors.",
    "ppv": 61.6,
    ...
    "commercialPayersNotes": "Kaiser Permanente: Conditional/restricted — must meet CMS NCDs for Medicare members; non-Medicare must use preferred labs. Kaiser Permanente: restricts (CMS NCD required for Medicare members). ",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 5,
    "sampleCitations": "https://www.freenome.com/blood-test-for-colorectal-cancer/",
    "testScope": "Single-cancer (CRC)",
    ...
    }},
  {
    ...
    "validationCohortSize": 1968,
    "validationCohortStudy": "CLiMB prospective study (EASL 2024, NCT03694600; n=1,968)",
    "numPublications": 2,
    "numPublicationsPlus": true,
    ...
    }},
  {
    ...
    "validationCohortSize": 2206,
    "validationCohortStudy": "ALTUS prospective study (AASLD November 2025, NCT05064553; n=2,206)",
    "numPublications": 3,
    "numPublicationsPlus": true,
    ...
    }},
  {
    ...
    "incidenceAdjustedSensitivity": null,
    "incidenceAdjustedSensitivityNotes": null,
    "incidenceAdjustedSensitivityCitations": null,
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://precision-epigenomics.com/wp-content/uploads/2024/04/",
    "name": "EPISEEK",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://clinicaltrials.gov/study/NCT06059963",
    "name": "Signal-C",
    "vendor": "Universal DX",
    "testScope": "Single-cancer (CRC)",
    ...
    }},
  {
    ...
    "validationCohortSize": 1164,
    "validationCohortStudy": "Multicenter clinical trial (J Mol Diagn 2022; n=1,164)",
    "numPublications": 4,
  ...
  },
  {
    ...
    "validationCohortSize": 772,
    "validationCohortStudy": "Ward et al. European Urology Oncology 2023 (3 UK clinical cohorts; 384 cancer, 388 controls)",
    "numPublications": 2,
  ...
  // OverC Multi-Cancer Detection Blood Test - Added December 2025
  {
    ...
    "incidenceAdjustedSensitivityCitations": null,
    "cancerTypeSensitivity": null,
    "stageISensitivity": 35.4,
    "stageISensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36849097/",
    ...
    "stageIISensitivity": 54.5,
    "stageIISensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36849097/",
    "stageIIISensitivity": 82.4,
    "stageIIISensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36849097/",
    "stageIVSensitivity": 93.8,
    "stageIVSensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36849097/",
    "specificity": 98.9,
    ...
    "validationCohortSize": 946,
    "validationCohortStudy": "THUNDER independent validation cohort (Annals of Oncology 2023; n=473 cancer + 473 non-cancer)",
    "numPublications": 2,
    "numPublicationsPlus": true,
    ...
    "perCancerEarlyStageSensitivity": {"Liver":{"pct":79.5,"n":null},"Ovary":{"pct":55.6,"n":null},"Colon/Rectum":{"pct":50.0,"n":null},"Esophagus":{"pct":32.0,"n":null},"Lung":{"pct":28.3,"n":null},"Pancreas":{"pct":26.5,"n":null}},
    "perCancerEarlyStageSensitivitySource": "THUNDER independent validation, MCDBT-1 (Gao et al., Annals of Oncology, 2023). Stage I-II combined from Supplementary Table S3.",
  ...
  // Cancerguard - Added December 2025 (LLM Data Review)
  {
    ...
    "indicationGroup": "MCED",
    "sensitivity": 64.1,
    "sensitivityCitations": "https://www.exactsciences.com/cancerguardtestinfo",
    "sensitivityType": "observed (case-control)",
    "incidenceAdjustedSensitivity": 60.6,
    "incidenceAdjustedSensitivityNotes": "Calculated IAS: Clinician Brochure Table 6-4 cancer-type-specific observed sensitivities weighted by SEER 2021 incidence proportions across 18 cancer types (excluding breast and prostate, which are not indicated for CancerGuard). See scripts/calculate-ias.js for full methodology. Note: IAS values are not directly comparable across tests with different specificities. CancerGuard operates at 97.4% specificity (2.6% FPR) vs 99.5% (0.5% FPR) for Galleri and EPISEEK.",
    "incidenceAdjustedSensitivityCitations": "https://www.exactsciences.com/cancerguardtestinfo | https://seer.cancer.gov/statfacts/",
    "cancerTypeSensitivity": [
      { "cancerType": "Lung", "stageI": { "detected": 9, "total": 46 }, "stageII": { "detected": 12, "total": 23 }, "stageIII": { "detected": 40, "total": 48 }, "stageIV": { "detected": 36, "total": 39 }, "overall": { "detected": 100, "total": 159 } },
      { "cancerType": "Colon/Rectum", "stageI": { "detected": 3, "total": 13 }, "stageII": { "detected": 11, "total": 18 }, "stageIII": { "detected": 22, "total": 25 }, "stageIV": { "detected": 26, "total": 27 }, "overall": { "detected": 67, "total": 88 } },
      { "cancerType": "Breast", "stageI": { "detected": 2, "total": 24 }, "stageII": { "detected": 12, "total": 30 }, "stageIII": { "detected": 14, "total": 23 }, "stageIV": { "detected": 9, "total": 9 }, "overall": { "detected": 37, "total": 88 } },
      { "cancerType": "Prostate", "stageI": { "detected": 1, "total": 13 }, "stageII": { "detected": 0, "total": 24 }, "stageIII": { "detected": 0, "total": 6 }, "stageIV": { "detected": 5, "total": 8 }, "overall": { "detected": 6, "total": 51 } },
      { "cancerType": "Uterus", "stageI": { "detected": 3, "total": 20 }, "stageII": { "detected": 1, "total": 4 }, "stageIII": { "detected": 5, "total": 7 }, "stageIV": { "detected": 5, "total": 6 }, "overall": { "detected": 15, "total": 39 } },
      { "cancerType": "Pancreas", "stageI": { "detected": 3, "total": 7 }, "stageII": { "detected": 6, "total": 8 }, "stageIII": { "detected": 7, "total": 7 }, "stageIV": { "detected": 13, "total": 14 }, "overall": { "detected": 29, "total": 37 } },
      { "cancerType": "Head and Neck", "stageI": { "detected": 6, "total": 10 }, "stageII": { "detected": 3, "total": 5 }, "stageIII": { "detected": 8, "total": 11 }, "stageIV": { "detected": 8, "total": 10 }, "overall": { "detected": 25, "total": 36 } },
      { "cancerType": "Kidney", "stageI": { "detected": 0, "total": 9 }, "stageII": { "detected": 3, "total": 4 }, "stageIII": { "detected": 2, "total": 4 }, "stageIV": { "detected": 10, "total": 11 }, "overall": { "detected": 15, "total": 32 } },
      { "cancerType": "Stomach", "stageI": { "detected": 2, "total": 5 }, "stageII": { "detected": 4, "total": 7 }, "stageIII": { "detected": 6, "total": 7 }, "stageIV": { "detected": 9, "total": 9 }, "overall": { "detected": 22, "total": 30 } },
      { "cancerType": "Bladder", "stageI": { "detected": 2, "total": 7 }, "stageII": { "detected": 6, "total": 9 }, "stageIII": { "detected": 4, "total": 4 }, "stageIV": { "detected": 6, "total": 6 }, "overall": { "detected": 19, "total": 28 } },
      { "cancerType": "Esophagus", "stageI": { "detected": 2, "total": 6 }, "stageII": { "detected": 2, "total": 5 }, "stageIII": { "detected": 6, "total": 8 }, "stageIV": { "detected": 6, "total": 7 }, "overall": { "detected": 17, "total": 27 } },
      { "cancerType": "Liver/Bile Duct", "stageI": { "detected": 2, "total": 5 }, "stageII": { "detected": 5, "total": 6 }, "stageIII": { "detected": 8, "total": 8 }, "stageIV": { "detected": 5, "total": 5 }, "overall": { "detected": 20, "total": 25 } },
      { "cancerType": "Anus", "stageI": { "detected": 0, "total": 1 }, "stageII": { "detected": 6, "total": 8 }, "stageIII": { "detected": 2, "total": 3 }, "stageIV": { "detected": 3, "total": 3 }, "overall": { "detected": 11, "total": 16 } },
      { "cancerType": "Ovary", "stageI": { "detected": 0, "total": 1 }, "stageII": { "detected": 0, "total": 1 }, "stageIII": { "detected": 6, "total": 7 }, "stageIV": { "detected": 2, "total": 3 }, "overall": { "detected": 10, "total": 14 } },
      { "cancerType": "Vulva", "stageI": { "detected": 1, "total": 6 }, "stageIII": { "detected": 2, "total": 3 }, "stageIV": { "detected": 2, "total": 2 }, "overall": { "detected": 6, "total": 13 } },
      { "cancerType": "Thyroid", "stageI": { "detected": 0, "total": 4 }, "stageII": { "detected": 0, "total": 4 }, "stageIV": { "detected": 3, "total": 4 }, "overall": { "detected": 3, "total": 13 } },
      { "cancerType": "Cervix", "stageI": { "detected": 2, "total": 2 }, "stageII": { "detected": 2, "total": 3 }, "stageIII": { "detected": 3, "total": 3 }, "stageIV": { "detected": 2, "total": 2 }, "overall": { "detected": 10, "total": 13 } },
      { "cancerType": "Small Intestine", "stageII": { "detected": 2, "total": 3 }, "stageIII": { "detected": 1, "total": 4 }, "stageIV": { "detected": 1, "total": 3 }, "overall": { "detected": 4, "total": 10 } },
      { "cancerType": "Non-Hodgkin Lymphoma", "stageI": { "detected": 0, "total": 1 }, "stageIII": { "detected": 1, "total": 2 }, "stageIV": { "detected": 3, "total": 4 }, "overall": { "detected": 4, "total": 7 } },
      { "cancerType": "Testis", "stageI": { "detected": 1, "total": 2 }, "overall": { "detected": 1, "total": 2 } },
      { "cancerType": "Multiple Myeloma", "stageI": { "detected": 0, "total": 1 }, "overall": { "detected": 0, "total": 1 } }
    ],
    "cancerTypeSensitivityCitations": "Exact Sciences. CancerGuard Clinician Brochure Table 6-5 (Test Development Study, n=729). Oct 2025.",
    "perCancerEarlyStageSensitivity": {"Liver":{"pct":62.0,"n":11},"Ovary":{"pct":52.0,"n":2},"Pancreas":{"pct":48.0,"n":15},"Head and Neck":{"pct":42.0,"n":15},"Gastric":{"pct":38.0,"n":12},"Lung":{"pct":35.0,"n":69},"Lymphoma":{"pct":32.0,"n":1},"Colon/Rectum":{"pct":30.0,"n":31},"Cervix":{"pct":28.0,"n":5},"Esophagus":{"pct":25.0,"n":11},"Bladder":{"pct":22.0,"n":16},"Endometrial":{"pct":20.0,"n":24},"Kidney":{"pct":16.0,"n":13},"Breast":{"pct":14.0,"n":54}},
    "perCancerEarlyStageSensitivitySource": "ASCEND-2 est.",
    "sensitivityNotes": "64.1% observed sensitivity across 19 cancer types (excluding breast and prostate) in test development case-control study (n=590 cancer, n=2,434 non-cancer). 67.8% sensitivity for 6 most aggressive cancers. Stage I: 24.8%, Stage II: 57.8%, Stage I+II combined: 39.0%. From Clinician Brochure test development data.",
    "stageISensitivity": 24.8,
    "stageISensitivityCitations": "https://www.exactsciences.com/cancerguardtestinfo",
    "stageISensitivityNotes": "24.8% Stage I sensitivity (36/145 detected, excluding breast and prostate). From test development study Table 6-3. Independent validation study showed 26.8% (15/56).",
    "stageIISensitivity": 57.8,
    "stageIISensitivityCitations": "https://www.exactsciences.com/cancerguardtestinfo",
    "stageIIISensitivity": 81.5,
    "stageIIISensitivityCitations": "https://www.exactsciences.com/cancerguardtestinfo",
    "stageIVSensitivity": 90.3,
    "stageIVSensitivityCitations": "https://www.exactsciences.com/cancerguardtestinfo",
    "specificity": 97.4,
    ...
    "specificityNotes": "97.4% specificity (2.6% false positive rate). In a screening population of 100,000 with ~1% cancer prevalence, expect ~2,574 false positives — approximately 5x more than tests operating at 99.5% specificity. Cross-test sensitivity comparisons should account for this difference; higher sensitivity may partly reflect lower detection threshold rather than superior cancer detection.",
    "ppv": 19.4,
    ...
    "performanceNotes": "Multi-analyte approach combining cfDNA methylation and protein biomarkers. Validation from DETECT-A (10,000 participants) and ASCEND-2 studies. FALCON registry (NCT06589310) enrolling ~25,000 participants for additional RWE. Note: CancerGuard's higher observed sensitivity relative to other MCED tests should be interpreted alongside its lower specificity (97.4% vs 99.5% for Galleri/EPISEEK), which results in approximately 5x more false positives in a screening population. PPV of 19.4% means roughly 1 in 5 positive results confirm cancer, compared to ~3 in 5 for Galleri.",
  ...
  },
  {
    ...
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    "cptCodesNotes": "SEPT9 (Septin 9) gene methylation analysis. Standard CPT code for methylated SEPT9 CRC screening.",
    "commercialPayers": [],
    "listPrice": 192,
  ...
  },
  {
    ...
    "validationCohortSize": 1194,
    "validationCohortStudy": "Multicenter clinical trial (BMC Medicine 2024, NCT05508503; n=1,194)",
    "numPublications": 2,
  ...
  },
  {
    ...
    "validationCohortSize": 1116,
    "validationCohortStudy": "Multicenter clinical trial (J Hematol Oncol 2024, NCT05680077; n=1,116)",
    "numPublications": 2,
  ...
  },
  {
    ...
    "validationCohortSize": 1182,
    "validationCohortStudy": "Multicenter clinical study (Clin Epigenetics 2025, NCT05668793; n=1,182)",
    "numPublications": 4,
  ...
  },
  {
    ...
    "validationCohortSize": 477,
    "validationCohortStudy": "Clinical validation study (Chinese Medical Journal 2024, PMID 37455255; n=477)",
    "numPublications": 1,
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://www.sciencedirect.com/science/article/pii/S1525157824002880",
    "name": "Avantect Pancreatic Cancer Test",
    "vendor": "ClearNote Health",
    "testScope": "Single-cancer (Pancreatic)",
    "approach": "Multianalyte cfDNA epigenomic (5hmC), genomic/genotyping, and glycan biomarker profiling",
    "method": "Multianalyte and multiomic assay integrating epigenomic 5-hydroxymethylcytosine (5hmC) patterns, genomic and genotyping information from cfDNA, and a glycan biomarker, combined with optimized machine learning algorithms for pancreatic cancer signal detection. Enhanced version (Feb 2026) of original 5hmC-only assay.",
    "methodCitations": "https://pubmed.ncbi.nlm.nih.gov/39230538/ | https://pubmed.ncbi.nlm.nih.gov/36967102/ | https://www.clearnotehealth.com/press-release/clearnote-healths-enhanced-avantect-pancreatic-cancer-test-delivers-industry-leading-early-detection-performance/",
    "cancerTypes": [
    ...
    "sensitivity": 82.6,
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36967102/ | https://www.clearnotehealth.com/press-release/clearnote-healths-enhanced-avantect-pancreatic-cancer-test-delivers-industry-leading-early-detection-performance/",
    "sensitivityNotes": "Enhanced test (Feb 2026): 82.6% overall sensitivity (95% CI: 77.45%-87.04%) across all stages. Early-stage (I/II) sensitivity 76.8% (95% CI: 68.87%-83.57%). Previous version (pre-2026): 68.3% early-stage sensitivity (95% CI: 51.9%-81.9%). Performance improvement driven by addition of genomic/genotyping and glycan biomarker analytes plus optimized ML. Source: press release and vendor correspondence; data cited as 'Data on File' — peer-reviewed publication pending (AACR/DDW 2026 presentations planned).",
    "stageISensitivity": 76.8,
    "stageISensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36967102/ | https://www.clearnotehealth.com/press-release/clearnote-healths-enhanced-avantect-pancreatic-cancer-test-delivers-industry-leading-early-detection-performance/",
    "stageISensitivityNotes": "Enhanced test: Stage I/II combined 76.8% (95% CI: 68.87%-83.57%). Previous version: 68.3% (95% CI: 51.9%-81.9%). Individual stage I vs II breakout not reported.",
    "stageIISensitivity": 76.8,
    "stageIISensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/36967102/ | https://www.clearnotehealth.com/press-release/clearnote-healths-enhanced-avantect-pancreatic-cancer-test-delivers-industry-leading-early-detection-performance/",
    "stageIISensitivityNotes": "Enhanced test: Stage I/II combined 76.8% (95% CI: 68.87%-83.57%). Individual stage II breakout not reported.",
    "stageIIISensitivity": null,
    ...
    "specificity": 97.5,
    "specificityCitations": "https://pubmed.ncbi.nlm.nih.gov/36967102/ | https://www.clearnotehealth.com/press-release/clearnote-healths-enhanced-avantect-pancreatic-cancer-test-delivers-industry-leading-early-detection-performance/",
    "specificityNotes": "Enhanced test (Feb 2026): 97.5% specificity (95% CI: 96.41%-98.29%). Previous version: 96.9% (95% CI: 96.1%-97.7%). Both measured vs non-cancer controls and non-pancreatic cancers.",
    "ppv": 25.0,
    ...
    "performanceCitations": "https://pubmed.ncbi.nlm.nih.gov/36967102/ | https://pubmed.ncbi.nlm.nih.gov/39230538/ | https://www.clearnotehealth.com/press-release/clearnote-healths-enhanced-avantect-pancreatic-cancer-test-delivers-industry-leading-early-detection-performance/",
    "performanceNotes": "ENHANCED TEST (Feb 2026): ClearNote Health released updated Avantect with multianalyte/multiomic approach adding genomic/genotyping and glycan biomarker to original 5hmC platform, with optimized ML. New performance: 82.6% overall sensitivity, 76.8% early-stage (I/II), 97.5% specificity. Data cited as 'Data on File'; peer-reviewed publication pending. Selected for NHS SAFE-D study and PRECEDE Consortium. ORIGINAL TEST VALIDATION: Blinded validation cohort: 3,674 participants (102 pancreatic cancer, 2,048 non-cancer, 1,524 non-pancreatic cancers). Analytical validation showed 100% precision concordance in biological replicates, sample stability up to 7 days post-collection, and >95% concordance with EM-Seq method. LOD studies showed equal performance between early- and late-stage samples.",
    ...
    "reimbursement": "Not covered",
    "reimbursementNote": "Not covered by Medicare per vendor (March 2026). CLFS rate $1,160 (CPT 0410U) but no active Medicare coverage policy. Commercial coverage expanding via Claritev/PHCS/MultiPlan networks.",
    "commercialPayers": [],
    ...
    "adltStatus": false,
    "listPrice": 1160,
    "listPriceNotes": "CLFS rate $1,160 (CPT 0410U). Previous $495 value was financial assistance/self-pay maximum, not list price — corrected per vendor March 2026. Financial assistance program available ($0-495 based on need).",
    ...
    "validationCohortSize": 3674,
    "validationCohortStudy": "Blinded validation cohort (Clin Gastroenterol Hepatol 2023, PMID 36967102; n=3,674)",
    "numPublications": 2,
    ...
    "technologyDifferentiator": "First commercially available single-cancer ECD test for pancreatic cancer in OpenOnco database. Enhanced (Feb 2026) multianalyte/multiomic approach: epigenomic 5hmC patterns + genomic/genotyping + glycan biomarker. Uses 5-hydroxymethylcytosine (5hmC) profiling rather than standard 5-methylcytosine (5mC) methylation—5hmC is an oxidized derivative of 5mC with distinct tissue-specific patterns. Targets defined high-risk population (new-onset T2DM, genetic predisposition, family history) rather than general population screening. Strong specificity (97.5%) critical for screening context where false positives lead to unnecessary workup.",
    "vendorVerified": true,
    "vendorRequestedChanges": "2025-12-16: Initial submission by Adrian Vilalta (ClearNote Health). 2025-12-29: Alex requested clarification on sensitivity discrepancy. 2026-01-05: Vendor confirmed sensitivity 68.3% correct as stated; verified data accuracy. 2026-03-02: Adrian Vilalta submitted enhanced test update — new performance (sensitivity 82.6%, early-stage 76.8%, specificity 97.5%), corrected Medicare to not covered, corrected list price from $495 to $1,160 CLFS rate."
  ,
    "medicareCoverage": {
      "status": "NOT_COVERED",
      "policyType": "CLFS",
      ...
      "cptCode": "0410U",
      "notes": "CLFS rate set at $1,160 (CPT 0410U) but vendor confirms no active Medicare coverage as of March 2026. NY State DOH approved.",
  ...
  },
  {
    ...
    "clinicalAvailability": "Early Access Programme (EAP) from March 2026 for collaborative projects; Phase 3 OncNGS clinical validation at 7 European centers",
    "tat": 5,
    "tatNotes": "4-7 days from blood draw to actionable results",
    "tatCitations": "https://oncodna.com/oncoxplore/",
  ...
  // SPOT-MAS - Added January 2026 (Vendor Submission - David Schlesinger, Gene Solutions)
  {
    "id": "ecd-28",
    "sampleCategory": "Blood/Plasma",
    "name": "SPOT-MAS",
    ...
    "testScope": "Multi-cancer",
    "indicationGroup": "MCED",
    "method": "Multi-omics analysis integrating ctDNA methylomics, fragmentomics, genomics, and end motifs with AI/machine learning for cancer detection and tissue-of-origin localization",
    "methodCitations": "https://pubmed.ncbi.nlm.nih.gov/37819044/",
    "cancerTypes": ["Breast", "Colorectal", "Gastric", "Lung", "Liver", "Ovarian", "Pancreatic", "Esophageal", "Head & Neck", "Endometrial"],
    "cancerTypesNotes": "Detects 10 major cancer types and 75 subtypes; strong performance in cancers lacking standard screening (stomach, liver-biliary, ovary, pancreas)",
    "sensitivity": 70.8,
    "sensitivityNotes": "70.8% overall sensitivity for cancerous lesions, 78.1% when including precancerous lesions in digestive tract; Stage I: 62.3%, Stage II: 73.9%, Stage IIIA: 88.3%",
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/37819044/, https://www.prnewswire.com/apac/news-releases/gene-solutions-leads-the-way-in-cancer-early-detection-with-asias-first-clinical-validated-multi-cancer-blood-test-302411672.html",
    "specificity": 99.7,
    "specificityNotes": "K-DETEK trial (n=9,024)",
    "specificityCitations": "https://www.prnewswire.com/apac/news-releases/gene-solutions-leads-the-way-in-cancer-early-detection-with-asias-first-clinical-validated-multi-cancer-blood-test-302411672.html",
    "stageISensitivity": 62.3,
    "stageISensitivityNotes": "Discovery cohort all-cancer Stage I sensitivity: 73.9%. Validation: 73.91% (n=23). K-DETEK prospective: 70.59% early/non-metastatic.",
    "stageISensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/37819044/",
    "stageIIISensitivity": 88.3,
    "stageIIISensitivityCitations": "https://doi.org/10.7554/eLife.89083",
    "ppv": 60,
    "ppvNotes": "From K-DETEK interim analysis",
    "ppvCitations": "https://biopharmaapac.com/news/43/2669/gene-solutions-latest-update-promising-multi-cancer-early-detection-in-southeast-asia.html",
    "npv": 99.9,
    "npvCitations": "https://doi.org/10.1186/s12916-025-03929-y",
    "npvNotes": "K-DETEK prospective validation NPV: 99.92%.",
    "tumorOriginAccuracy": 70.0,
    "tumorOriginAccuracyNotes": "70% tissue-of-origin accuracy in eLife case-control. K-DETEK prospective: 84% TOO accuracy.",
    "tumorOriginAccuracyCitations": "https://doi.org/10.7554/eLife.89083",
    "sampleVolumeMl": 10,
    "sampleCitations": "https://www.prnewswire.com/apac/news-releases/gene-solutions-leads-the-way-in-cancer-early-detection-with-asias-first-clinical-validated-multi-cancer-blood-test-302411672.html",
    "fdaStatus": "Not FDA cleared",
    "fdaStatusNotes": "US validation underway with Pangea Laboratory; available as LDT in Asian markets",
    "reimbursement": "Not covered",
    ...
    "numPublications": 19,
    "numPublicationsPlus": true,
    "numPublicationsCitations": "https://spotmas.com/publications/",
    "numPublicationsNotes": "eLife (case-control, n=2,288), BMC Medicine (K-DETEK trial), ESMO Annals of Oncology (real-world, n=10,577)",
    "performanceNotes": "eLife case-control (n=2,288): 72.4% sensitivity, 97% specificity across breast, CRC, gastric, liver, lung. K-DETEK prospective (n=9,057): 70.83% sensitivity, 99.71% specificity, 58.1% PPV, 99.92% NPV. Cost-effective shallow sequencing (~0.55x) enables population-wide screening.",
    "performanceCitations": "https://doi.org/10.7554/eLife.89083 | https://doi.org/10.1186/s12916-025-03929-y",
    "technologyDifferentiator": "Multimodal cfDNA analysis combining 5 feature types (targeted methylation, genome-wide methylation, fragment length, copy number, end motifs) in a single low-cost workflow. Shallow sequencing depth (~0.55x) vs competitors requiring 30x+, enabling significantly lower cost per test. First MCED test clinically validated in a large prospective Asian cohort.",
    "perCancerEarlyStageSensitivity": {"Liver":{"pct":83.3,"n":null},"Colon/Rectum":{"pct":80.0,"n":null},"Gastric":{"pct":100.0,"n":7},"Breast":{"pct":46.7,"n":null}},
    "perCancerEarlyStageSensitivitySource": "eLife 2023 validation cohort, Table S8 (Nguyen et al., doi:10.7554/eLife.89083). Stage I-II combined. Lung excluded (n=3). Gastric n=7 (small sample).",
    "validationCohortSize": 9024,
    "validationCohortStudy": "K-DETEK prospective trial",
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": true,
    "regulatoryStatusNotes": "CAP-accredited NGS laboratories in Singapore and Vietnam",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-22: Initial submission by David Schlesinger (Gene Solutions)"
  },
  // ClarityDX Prostate - Added January 2026 (Protean BioDiagnostics)
  {
    "id": "ecd-29",
    "sampleCategory": "Blood/Plasma",
    "name": "ClarityDX Prostate",
    "vendor": "Protean BioDiagnostics / Nanostics",
    "indicationGroup": "Prostate",
    "approach": "Machine learning risk prediction",
    "method": "Combines blood-based biomarkers (PSA, free PSA) with clinical information using optimized machine learning algorithms to generate a risk score for clinically significant prostate cancer (grade group ≥2). Uses gradient-boosting machine algorithm.",
    "methodCitations": "https://www.nature.com/articles/s41746-024-01167-9",
    "cancerTypes": ["Prostate"],
    "cancerTypesNotes": "Clinically significant prostate cancer (grade group ≥2). For men 40-75 years with PSA ≥3 ng/mL and clinical suspicion (elevated PSA, abnormal DRE, symptoms). No prior prostate cancer diagnosis.",
    "cancerTypesCitations": "https://www.proteanbiodx.com/claritydx",
    "sampleTubeType": "SST (Serum Separator Tube)",
    "sampleTubeCount": 2,
    "sampleCollectionNotes": "Blood sample, spun down. Stable 5 days at 2-8°C, 24h at room temp. Freeze at -20°C after centrifugation.",
    "sampleCitations": "https://www.proteanbiodx.com/claritydx",
    "requiresTumorTissue": "No",
    "requiresTumorTissueNotes": "Non-invasive blood test used before biopsy decision",
    "requiresMatchedNormal": "No",
    "sensitivity": 95,
    "sensitivityNotes": "At ≥25% risk threshold. Validation cohort n=1,257. Higher than PSA or %free PSA alone.",
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/38902526/",
    "specificity": 35,
    "specificityNotes": "At ≥25% threshold. Could avoid up to 35% of unnecessary biopsies.",
    "specificityCitations": "https://pubmed.ncbi.nlm.nih.gov/38902526/",
    "ppv": 54,
    "ppvNotes": "At ≥25% threshold in validation cohort",
    "ppvCitations": "https://pubmed.ncbi.nlm.nih.gov/38902526/",
    "npv": 91,
    "npvNotes": "At ≥25% threshold in validation cohort",
    "npvCitations": "https://pubmed.ncbi.nlm.nih.gov/38902526/",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "Not FDA cleared. CLIA-certified, CAP-accredited lab in Orlando, FL.",
    "reimbursement": "Limited/Pending",
    "reimbursementNote": "PLA code granted by AMA (2025). Coverage varies by payer.",
    "clinicalAvailability": "Commercially available",
    "availableRegions": ["US", "Canada"],
    "tat": 5,
    "tatNotes": "3-5 business days",
    "tatCitations": "https://www.proteanbiodx.com/claritydx",
    "totalParticipants": 3448,
    "numPublications": 3,
    "numPublicationsCitations": "https://pubmed.ncbi.nlm.nih.gov/38902526/",
    "numPublicationsNotes": "Nature npj Digital Medicine 2024 (n=3,448 from UCLA, Johns Hopkins, U Calgary, U Alberta, Thomayer U Hospital).",
    "validationCohortSize": 1257,
    "validationCohortStudy": "International multi-site validation",
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": true,
    "regulatoryStatusNotes": "CLIA LDT via Protean BioDx (US) and Nanostics (Canada). Original test developed by Nanostics Inc.",
    "vendorVerified": false,
    "vendorRequestedChanges": "",
    "testScope": "Single-cancer",
    "screeningPopulation": "Men with elevated PSA (≥3 ng/mL) or abnormal DRE considering biopsy",
    "intendedUse": "Reflex test after elevated PSA to help determine need for prostate biopsy"
  },
  // OnkoSkan - Added January 2026 (Protean BioDiagnostics)
  {
    "id": "ecd-30",
    "sampleCategory": "Blood/Plasma",
    "name": "OnkoSkan",
    "vendor": "Protean BioDiagnostics / ECS-Progastrin",
    "indicationGroup": "MCED",
    "approach": "Circulating progastrin (hPG80) detection",
    "method": "Sandwich ELISA assay (DxPG80) measuring hPG80 (human circulating progastrin) in EDTA plasma. hPG80 is produced by cancer cells and correlates with tumor burden. No cross-reactivity to other gastrin peptides.",
    "methodCitations": "https://pubmed.ncbi.nlm.nih.gov/34494619/",
    "cancerTypes": ["Colorectal", "Pancreatic", "Liver/HCC", "Lung", "Gastric", "Kidney/RCC", "Breast", "Ovarian", "Neuroendocrine", "Glioblastoma"],
    "cancerTypesNotes": "Pan-cancer biomarker applicable to 16+ cancer types. GAST gene (encoding progastrin) is activated across multiple tumor origins. For non-pregnant adults 18+.",
    "cancerTypesCitations": "https://pubmed.ncbi.nlm.nih.gov/31877416/",
    "sampleTubeType": "EDTA",
    "sampleCollectionNotes": "Frozen plasma required. Store at -20°C or 2-8°C. Do not freeze whole blood.",
    "sampleCitations": "https://www.proteanbiodx.com/ordering",
    "requiresTumorTissue": "No",
    "requiresTumorTissueNotes": "Blood-based biomarker only",
    "requiresMatchedNormal": "No",
    "sensitivityNotes": "Median hPG80 in cancer patients: 4.88 pM vs 1.05 pM in healthy donors (p<0.0001). Detected in 84% of HCC patients.",
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/31877416/",
    "specificityNotes": "High analytical specificity - no cross-reactivity with other gastrin peptides. No interference from PPI usage.",
    "specificityCitations": "https://pubmed.ncbi.nlm.nih.gov/34494619/",
    "lod": "1 pM",
    "lodNotes": "LoD: 1 pM. LoQ: 3.3 pM. Linear 0-50 pM.",
    "lodCitations": "https://pubs.rsc.org/en/content/articlelanding/2021/ay/d1ay00986a",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "Not FDA cleared. DxPG80 assay by ECS-Progastrin (Switzerland), offered via Protean BioDx.",
    "reimbursement": "Not covered",
    "reimbursementNote": "Self-pay or clinical trial",
    "clinicalAvailability": "Commercially available",
    "availableRegions": ["US", "EU"],
    "tat": 5,
    "tatNotes": "2-5 business days",
    "tatCitations": "https://www.proteanbiodx.com/liquidbx",
    "clinicalTrials": "NCT03775473, NCT05157594",
    "clinicalTrialsCitations": "https://clinicaltrials.gov/ct2/show/NCT03775473",
    "totalParticipants": 1546,
    "numPublications": 8,
    "numPublicationsCitations": "https://pubmed.ncbi.nlm.nih.gov/31877416/",
    "numPublicationsNotes": "EBioMedicine 2020 (n=1,546, 11 cancer types). NENs 2022 (n=95). HCC prognosis 2022 (n=168).",
    "validationCohortSize": 1546,
    "validationCohortStudy": "Multi-center international study",
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": true,
    "regulatoryStatusNotes": "DxPG80 kit by ECS-Progastrin. Offered as LDT via Protean BioDx.",
    "vendorVerified": false,
    "vendorRequestedChanges": "",
    "testScope": "Multi-cancer",
    "perCancerEarlyStageSensitivity": {},
    "screeningPopulation": "Adults 18+ with suspected cancer or for treatment response monitoring",
    "intendedUse": "Cancer screening and treatment response monitoring via circulating progastrin levels"
  },
  {
    "id": "ecd-31",
    "sampleCategory": "Blood/Plasma",
    ...
    "vendor": "Caris Life Sciences",
    "testScope": "Multi-cancer (MCED)",
    "approach": "Blood-based cfDNA MCED (plasma) via extreme ultra-deep Whole Genome Sequencing + AI",
    "method": "Ultra-deep Whole Genome Sequencing (WGS) combined with AI/machine-learning models trained on 1M+ molecular profiles and 50B+ molecular markers; analyzes mutations, epigenomic changes, transcriptomic patterns, and aneuploidy from cfDNA; does not require prior tissue biopsy.",
    "methodCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html | https://www.carislifesciences.com/about/news-and-media/caris-life-sciences-partners-with-everlywell-to-launch-caris-forthcoming-mced-assay-caris-detect/",
    "methodNotes": "Caris Detect is a distinct product from Caris Assure (which is commercially available for therapy selection in advanced cancers). The July 2025 Caris Assure Scientific Reports paper demonstrated MCED capability using the Assure platform with DIFFERENT methodology and performance numbers (83-96% stage I-IV sensitivity at 99.6% specificity). Those numbers apply to Caris Assure, NOT Caris Detect. Do not conflate the two products.",
    "cancerTypes": ["Multi-cancer; specific cancer type list not yet disclosed"],
    "cancerTypesCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-announces-new-study-demonstrating-the-power-and-clinical-utility-of-its-caris-assure-blood-based-assay-for-multi-cancer-early-detection-minimal-residual-disease-and-therapy-selection-302499499.html",
    "cancerTypesNotes": "Achieve 1 interim does not disclose the full list of cancer types evaluated. Cancer-type-specific Stage I+II sensitivity from Q4 2025 earnings slides: lung 87%, prostate 79%, head & neck 100% — other cancer types not disclosed. The Caris Assure platform (separate product) covers solid tumor types broadly, but the Caris Detect cancer panel may differ.",
    ...
    "perCancerEarlyStageSensitivitySource": "Achieve 1 interim readout (Caris Life Sciences, Feb 2026)",
    "sensitivity": null,
    "sensitivityNotes": "Overall all-stages sensitivity not separately reported by Caris for Achieve 1; they report 61.3% as combined Stage I-II sensitivity only. This is NOT comparable to the overall sensitivity field used for other MCED tests (e.g., Galleri 51.5% overall, Cancerguard 64% overall, Shield MCD 60% overall). Breakdown: Stage I 56.8% (n=266), Stage II 70.1% (stage II n not separately reported), Stage IV 99.1% (n=109). Stage III not separately reported. Cancer-type-specific Stage I+II sensitivity: lung 87%, prostate 79%, head & neck 100% (source: Caris Q4 2025 earnings slides). CRITICAL CAVEATS: (1) Interim data using cross-validation methodology — cross-validation typically produces more optimistic estimates than prospective blinded validation; ~865 blinded hold-out samples are pending validation, expected Q1 2026. (2) Enriched cohort — the undiagnosed population had ~7% subsequent cancer diagnosis rate, substantially higher than general screening prevalence (~0.5-1%). (3) Many cancer-specific sample counts are small (several n≤7), reducing precision for individual cancer type estimates.",
    "sensitivityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    "sensitivityType": "Stage I-II combined only (overall all-stages sensitivity not reported)",
    "stageISensitivity": 56.8,
    "stageISensitivityNotes": "Achieve 1 interim readout, cross-validation, n=266 Stage I cancers",
    "stageISensitivityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    "stageIISensitivity": 70.1,
    "stageIISensitivityNotes": "Achieve 1 interim readout, cross-validation. Stage II sample count (n) not separately reported in press release; 70.1% derived from aggregate data.",
    "stageIISensitivityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    "stageIIISensitivity": null,
    "stageIIISensitivityNotes": "Stage III sensitivity not separately reported in Achieve 1 interim readout. Caris Q4 2025 earnings presentation references sensitivity 'ranging from 56.8% for Stage I to 99.1% for Stage IV' without explicit Stage III breakout. Investing.com coverage estimated ~85% for select cancers based on earnings slides, but this is not an official Caris-reported figure.",
    "stageIVSensitivity": 99.1,
    "stageIVSensitivityNotes": "Achieve 1 interim readout, n=109 Stage IV cancers",
    "stageIVSensitivityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    "specificity": 99.1,
    "specificityNotes": "TWO SPECIFICITY VALUES REPORTED: (1) 99.1% in the Asymptomatic Screening Population (n=121) — subjects with no symptoms, no significant cancer risk factors, and no subsequent cancer diagnosis within 1 year of blood draw. This is a highly selected, small subgroup. (2) 95.3% in the broader Undiagnosed Population (n=1,505) — screening and symptomatic screening subjects. The 99.1% figure is used as the primary specificity as it most closely reflects a true asymptomatic screening use case, but the n=121 sample size limits statistical precision. For comparison: Galleri 99.5% (n=6,290 non-cancer), Shield MCD 98.5%, Cancerguard 97.4%.",
    "specificityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    "ppv": null,
    "npv": null,
    "performanceNotes": "STUDY DESIGN: Achieve 1 interim readout (Feb 26, 2026). Total n=2,122 samples: 1,505 undiagnosed subjects (screening and symptomatic screening population) + 617 cancer cases across stages I-IV. METHODOLOGY: First phase used cross-validation approach; ~865 samples held out for blinded validation still in process (results expected Q1 2026). Cross-validation can overestimate performance compared to prospective blinded testing. COHORT ENRICHMENT: The undiagnosed population was enriched for higher-risk subjects — among ~600 subjects with 1-year follow-up, ~7% were subsequently diagnosed with cancer, well above general screening prevalence. TECHNOLOGY: Caris claims superior early-stage sensitivity vs methylation-only MCED approaches (Galleri, Shield MCD) due to multi-modal genomic analysis covering mutations + epigenomics + transcriptomics + aneuploidy via extreme ultra-deep WGS. An updated assay additionally incorporating Whole Transcriptome Sequencing (WTS) is in development. RELATIONSHIP TO CARIS ASSURE: Caris Detect is a separate forthcoming screening product; Caris Assure is the existing therapy selection liquid biopsy. The July 2025 Scientific Reports publication (Nature journal) validated Caris Assure MCED capability with different performance numbers — do not conflate with Caris Detect Achieve 1 data.",
    "performanceCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html | https://www.investing.com/news/company-news/caris-life-sciences-q4-2025-slides-revenue-surges-125-on-profiling-growth-93CH-4530148",
    "fdaStatus": "Pre-market; not yet commercially available. No FDA approval, clearance, or Breakthrough Device designation for Caris Detect. Note: Caris Assure (therapy selection) is a separate, commercially available CLIA-validated test. Caris Life Sciences is publicly traded (NASDAQ: CAI).",
    "fdaStatusNotes": "Caris Detect is a forthcoming MCED test expected to launch H1 2026. Achieve 1 study supports commercial launch. Blinded validation pending.",
    "reimbursement": "Not covered",
    "reimbursementNote": "Pre-launch; no coverage established. Will be distributed through Everlywell consumer platform.",
    "listPrice": null,
    "listPriceNotes": "Not yet announced; expected at commercial launch H1 2026",
    "commercialPayers": [],
    "availableRegions": ["US (planned)"],
    "clinicalAvailability": "Not yet commercially available; expected H1 2026 launch through Everlywell partnership",
    "clinicalAvailabilityNotes": "Caris announced Everlywell distribution partnership Jan 12, 2026. Commercial launch expected H1 2026 pending blinded validation results.",
    "tat": null,
    "sampleType": "Whole blood (plasma cfDNA)",
    "sampleTubeType": null,
    "sampleTubeCount": null,
    "sampleVolumeMl": null,
    ...
    "cptCode": null,
    "screeningInterval": null,
    "clinicalTrials": "Achieve 1 (supporting launch of Caris Detect; n=2,122 interim); Achieve 2 (planned)",
    "clinicalTrialsCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    "totalParticipants": 2122,
    "totalParticipantsNotes": "Achieve 1 interim cohort; ~865 additional blinded hold-out samples pending",
    "numPublications": 0,
    "numPublicationsNotes": "Zero peer-reviewed publications specific to Caris Detect as of March 2026. All Achieve 1 data is from press releases only. The July 2025 Scientific Reports (Nature journal) publication validated the Caris Assure platform (separate product) for MCED capability — that paper is not a Caris Detect publication. Peer-reviewed Achieve 1 results have not been published.",
    "numPublicationsCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-announces-new-study-demonstrating-the-power-and-clinical-utility-of-its-caris-assure-blood-based-assay-for-multi-cancer-early-detection-minimal-residual-disease-and-therapy-selection-302499499.html",
    "tumorOriginAccuracy": null,
    "tumorOriginAccuracyNotes": "Tissue of origin prediction not reported in Achieve 1 interim; Caris Assure study (July 2025) demonstrated diagnostic pathway predictor (ABCDai-GPS model)",
    "technologyDifferentiator": "Only MCED test using extreme ultra-deep Whole Genome Sequencing (vs methylation-only approaches); multi-modal analysis covering mutations, epigenomics, transcriptomics, and aneuploidy; leverages 1M+ profiled cases and 50B+ molecular markers for AI training",
    "isRUO": false,
    "isInvestigational": true,
    "isInvestigationalNotes": "Pre-launch investigational MCED test; Achieve 1 blinded validation pending",
    "isClinicalLDT": false,
    "vendorVerified": false,
    "validationCohortSize": 2122,
    "validationCohortStudy": "Achieve 1 (interim cross-validation)",
    "website": "https://www.carislifesciences.com/",
    "medicareCoverage": "{status=NOT_COVERED, policyType=null, policyNumber=null, policyName=null, coveredIndications=[], reimbursementRate=null, cptCode=null, notes=Pre-launch; no Medicare coverage established., lastVerified=2026-03-03}",
    "dataSourceNotes": "Data sourced from Achieve 1 interim press release (Feb 26, 2026) and Caris/Everlywell partnership announcement (Jan 12, 2026). Performance data is interim cross-validation; blinded validation pending. Some cancer-specific sample counts are small (n≤7 for several types)."
  },
  // Harbinger Health MCED - Added March 2026
  {
    "id": "ecd-33",
    "sampleCategory": "Blood/Plasma",
    "name": "Harbinger MCED",
    "vendor": "Harbinger Health",
    "testScope": "Multi-cancer (MCED)",
    "approach": "Blood-based protein + cfDNA MCED",
    "method": "Proprietary multi-analyte platform combining protein biomarkers and cfDNA analysis for multi-cancer detection",
    "methodCitations": null,
    "methodNotes": null,
    "cancerTypes": ["15+ tumor types including hepatobiliary, upper GI, colorectal, lung"],
    "cancerTypesCitations": null,
    "cancerTypesNotes": null,
    "detectedCancerTypes": null,
    "detectedCancerTypesNotes": null,
    "targetPopulation": "Adults at average risk for cancer",
    "indicationGroup": "MCED",
    "sensitivity": 25.8,
    "sensitivityCitations": null,
    "sensitivityNotes": "CORE-HH prospective (ASCO 2025): 25.8% early-stage (I-II) at 98.3% specificity. Earlier 2023 pilot (case-control): 82% overall, 74% Stage I, 84% Stage II at 95% spec across 15 tumor types. Dramatic gap reflects case-control optimism vs prospective reality.",
    "sensitivityType": null,
    "incidenceAdjustedSensitivity": null,
    "incidenceAdjustedSensitivityNotes": null,
    "incidenceAdjustedSensitivityCitations": null,
    "cancerTypeSensitivity": null,
    "cancerTypeSensitivityCitations": null,
    "cancerTypeSensitivityNotes": null,
    "stageISensitivity": null,
    "stageISensitivityCitations": null,
    "stageISensitivityNotes": null,
    "stageIISensitivity": null,
    "stageIISensitivityCitations": null,
    "stageIISensitivityNotes": null,
    "stageIIISensitivity": null,
    "stageIIISensitivityCitations": null,
    "stageIIISensitivityNotes": null,
    "stageIVSensitivity": null,
    "stageIVSensitivityCitations": null,
    "stageIVSensitivityNotes": null,
    "specificity": 98.3,
    "specificityCitations": null,
    "specificityNotes": "CORE-HH prospective study specificity. 2023 pilot: 95%.",
    "ppv": null,
    "ppvCitations": null,
    "ppvNotes": null,
    "ppvDefinition": null,
    ...
    "npvDefinition": null,
    "tumorOriginAccuracy": null,
    "tumorOriginAccuracyNotes": null,
    "tumorOriginAccuracyCitations": null,
    "performanceCitations": null,
    "performanceNotes": "Two datasets with dramatically different results. 2023 pilot (case-control): 82% overall sensitivity, 74% Stage I, 84% Stage II at 95% specificity across 15 tumor types (GenomeWeb). 2025 CORE-HH (ASCO, prospective): 25.8% early-stage (I-II) at 98.3% specificity, 80.3% late-stage (III-IV). Per-cancer PPV reported (hepatobiliary 15%, upper GI 22%, colorectal 33%, lung 25%) but per-cancer sensitivity not published.",
    "leadTimeNotes": null,
    "fdaStatus": "Investigational; not commercially available",
    "fdaStatusCitations": null,
    "fdaStatusNotes": null,
    "reimbursement": "Not applicable (investigational)",
    "reimbursementNote": null,
    "reimbursementCitations": null,
    "commercialPayers": [],
    "commercialPayersCitations": null,
    "commercialPayersNotes": "Aetna: Not covered (CPB 0352). Aetna: denies (CPB 0352 — not covered under traditional tumor marker policy). ",
    "commercialPayersNonCoverage": ["Aetna"],
    "commercialPayersNonCoverageNotes": "Aetna: Not covered (CPB 0352).",
    "availableRegions": [],
    "availableRegionsNotes": null,
    "clinicalAvailability": "Not commercially available; investigational only",
    "clinicalAvailabilityNotes": null,
    "tat": null,
    "tatNotes": null,
    "tatCitations": null,
    "sampleType": null,
    ...
    "cptCode": null,
    "listPrice": null,
    "listPriceCitations": null,
    "listPriceNotes": null,
    "screeningInterval": null,
    "clinicalTrials": null,
    "clinicalTrialsCitations": null,
    "totalParticipants": null,
    "totalParticipantsCitations": null,
    "totalParticipantsNotes": null,
    "validationCohortSize": null,
    "validationCohortStudy": null,
    "numPublications": null,
    "numPublicationsCitations": null,
    "numPublicationsNotes": null,
    "numPublicationsPlus": false,
    "isInvestigational": true,
    "isInvestigationalNotes": "Pre-commercial. No FDA submission announced.",
    "isClinicalLDT": false,
    "isRUO": false,
    "technologyDifferentiator": "Combines protein biomarkers with cfDNA analysis. Notable for the dramatic performance gap between case-control (82%) and prospective (25.8%) validation, illustrating the challenges of translating MCED performance to real-world screening.",
    "perCancerEarlyStageSensitivity": {},
    "perCancerEarlyStageSensitivitySource": null,
    "vendorVerified": false,
    "category": "ECD",
...
export const cgpTestData = [
  ...
  },
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf20/P200006B.pdf",
    "approach": "Liquid CGP",
  ...
  },
  {
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "FoundationOne Heme PLA code (BCBSM EST status Jan 2025). Hematologic malignancies and sarcoma CGP.",
    "listPrice": 3500,
    "listPriceCitations": "https://www.foundationmedicine.com/faq/patient-faqs",
    "availableRegions": ["US", "EU", "UK", "Japan", "Canada", "Australia", "International"],
  ...
  },
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf20/P200010S008C.pdf",
    "approach": "Liquid CGP",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://guardanthealth.com/wp-content/uploads/REC-REG-000010",
    "approach": "Liquid CGP",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://mlabs.umich.edu/tests/tempus-genomic-sequencing",
    "approach": "Liquid CGP",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://www.tempus.com/wp-content/uploads/2022/10/Tempus-LS_",
    "approach": "Liquid CGP",
  ...
  },
  {
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "MSK-IMPACT PLA code (BCBSM EI status Jan 2025). First tumor-profiling multiplex panel to receive FDA authorization."
  ,
    "medicareCoverage": {
      "status": "COVERED",
      "policyType": "NCD",
    ...
    }},
  {
    ...
    "analyticalValidation": "97-100% positive and negative percent agreement compared to other FDA-approved assays. Oncotarget Aug 2025 independent validation confirmed 97-100% concordance for SNVs, indels, MSI, and TMB.",
    "analyticalValidationCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-demonstrates-scientific-rigor-with-clinical-validation-of-fda-approved-mi-cancer-seek-302530610.html | Oncotarget Aug 2025 MI Cancer Seek CDx validation",
    "numPublications": 30,
    "numPublicationsPlus": true,
  ...
  },
  {
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "StrataNGS PLA code (BCBSM EI status Jan 2025). 429-gene tissue CGP panel.",
    "clinicalAvailability": "Commercially available in US",
    ...
    }},
  {
    ...
    "methodCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/ | https://www.carislifesciences.com/molecular-intelligence-platform/",
    "genesAnalyzed": 22000,
    "genesAnalyzedNotes": "WES/WTS interrogates ~22,000 genes; protein analysis adds expression-level biomarkers.",
    "genesAnalyzedCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    "geneListUrl": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    ...
    "biomarkersReportedCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/ | https://www.carislifesciences.com/physicians/physician-tests/whole-exome-sequencing/homologous-recombination-deficiency-hrd/",
    "cancerTypes": ["All solid tumors"],
    "cancerTypesCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    "targetPopulation": "Patients requiring comprehensive multi-omic tumor profiling",
    "targetPopulationCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    ...
    "fdaStatusCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/ | https://www.carislifesciences.com/about/news-and-media/caris-life-sciences-receives-fda-approval-for-mi-cancer-seek/",
    "vendorClaimsNCCNAlignment": true,
    "vendorNCCNAlignmentCitation": "https://www.molecularmd.com/",
    ...
    "tat": "10-14 days",
    "tatCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    "sampleRequirements": "FFPE tissue",
    "sampleRequirementsCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    "reimbursement": "Coverage Varies",
    "reimbursementNote": "Coverage varies by payer and specific tests ordered.",
    "reimbursementCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    "clinicalAvailability": "Commercially available in US",
    "clinicalAvailabilityCitations": "https://www.carislifesciences.com/physicians/physician-tests/mi-profile/",
    "numPublications": 100,
    "numPublicationsPlus": true,
    "numPublicationsNotes": "Caris flagship test; 165+ publications across platform. Key recent: GPSai tissue-of-origin AI tool (Cancer Res Commun Sep 2025, 95% accuracy across 28 tumor types), T-DXd resistance mechanisms (npj Breast Cancer Feb 2026).",
    "numPublicationsCitations": "https://www.carislifesciences.com/publications/ | Cancer Res Commun Sep 2025 (GPSai) | npj Breast Cancer Feb 2026 (T-DXd resistance)",
    "financialAssistance": "Financial Assistance Program available",
    "medicareCoverage": {
      "status": "COVERED",
      "policyType": "LCD",
    ...
    }},
  {
    ...
    "numPublications": 6,
    "numPublicationsPlus": true,
    "numPublicationsNotes": "NeoGenomics tissue profiling panel; newer product (launched March 2023). PanTracer LBx liquid biopsy complement launched with 96.9% sensitivity and 99.3% specificity.",
    ...
    "financialAssistance": "Patient billing support and appeals assistance. Contact: 866.776.5907 (Option 9)",
    "relatedTests": "NEO PanTracer LBx (liquid biopsy complement): 96.9% sensitivity, 99.3% specificity in analytical validation."
  },
  {
    "id": "tds-16",
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "Northstar Select PLA code (BCBSM EI status Jan 2025). 84-gene liquid biopsy CGP.",
    ...
    "validationCohortSize": 182,
    "validationCohortStudy": "Prospective head-to-head validation (J Liq Biopsy 2025; n=182, 17+ tumor types)",
    "smallSampleWarning": true,
    ...
    }},
  {
    ...
    "sampleRequirements": "Blood draw in Li-Heparin tube",
    "sampleRequirementsNotes": "Simple blood draw collected in Li-Heparin tube. No DRE required prior to collection.",
    "sampleRequirementsCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf20/P200048B.pdf | https://www.clevelanddx.com/isopsa-testing",
    ...
    "validationCohortSize": 888,
    "validationCohortStudy": "Prospective multicenter validation (Klein EA et al. Eur Urol 2017; n=888)",
    "numPublications": 10,
    "numPublicationsPlus": true,
    ...
    "vendorRequestedChanges": "2026-01-30: Tube type correction - changed from 'Streck tube' to 'Li-Heparin' per Lu Zhang (Streck) review citing FDA PMA P200048B."
  ,
    "medicareCoverage": {
      "status": "COVERED",
      "policyType": "LCD",
    ...
    }},
  {
    ...
    "sampleTubeType": "Streck cfDNA BCT",
    "sampleTubeCount": 2,
    "sampleCitations": "https://valleyhealth.testcatalog.org/show/LUCHM",
    ...
    "validationCohortSize": 1592,
    "validationCohortStudy": "Clinical validation cohort (Poh et al. PLoS One 2022; n=1,592 across 30+ cancer types)",
    "numPublications": 10,
    "numPublicationsPlus": true,
    ...
    }},
  {
    ...
    "sampleTubeType": "Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf21/P210040C.pdf",
    ...
    "methodCitations": "https://www.fda.gov/medical-devices/recently-approved-devices/agilent-resolution-ctdx-first-p210040 | https://www.fda.gov/medical-devices/recently-approved-devices/agilent-resolution-ctdx-first-p210040",
    ...
    "genesAnalyzedCitations": "https://www.fda.gov/medical-devices/recently-approved-devices/agilent-resolution-ctdx-first-p210040",
    "geneListUrl": "https://www.fda.gov/medical-devices/recently-approved-devices/agilent-resolution-ctdx-first-p210040",
  ...
  },
  {
    ...
    "validationCohortSize": 904,
    "validationCohortStudy": "101-gene panel validation (Fan et al. Cancer Medicine 2024; n=904)",
    "numPublications": 129,
  ...
  // ============================================
  {
    ...
    "reimbursement": "Medicare NCD 90.2 (CGP with CDx); CMS CLFS reimbursement $2,989.55 (PLA 0543U, effective Jan 1 2026)",
    "reimbursementNote": "FDA-approved CGP with CDx claims covered under NCD 90.2. CMS assigned PLA code 0543U with CLFS rate $2,989.55 effective January 1, 2026. CDx indications: NTRK fusions (larotrectinib, pan-tumor) and RET fusions (selpercatinib, NSCLC).",
    "cptCodes": "0543U",
    "cptCodesNotes": "PLA code 0543U assigned for TruSight Oncology Comprehensive. CLFS rate $2,989.55 effective Jan 1, 2026.",
    "medicareRate": 2989.55,
    "medicareStatus": "Priced",
    "medicareEffective": "2026-01-01",
    ...
    "medicareCoverage": {
      ...
      "coveredIndications": [
        "Pan-solid tumor CGP",
        "CDx: NTRK fusions (larotrectinib)",
        "CDx: RET fusions in NSCLC (selpercatinib)"
      ],
      "reimbursementRate": "$2,989.55",
      "cptCode": "0543U",
      "notes": "FDA PMA approved Aug 27 2024 (P230011). 517-gene CGP IVD kit. CMS CLFS rate effective Jan 1, 2026.",
      "lastVerified": "2026-02-09"
    }
  },
  {
  ...
  },
  {
    ...
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "PGDx elio tissue complete PLA code. Comprehensive solid tumor CGP kit.",
    "tmb": "Yes",
    "msi": "Yes",
  ...
  },
  {
    ...
    "genesAnalyzed": 517,
    "cancerTypes": ["Pan-solid tumor"],
    "indicationsNotes": "Primarily positioned for oncology research. DNA+RNA workflow captures both mutation and fusion biomarkers. Popular choice for labs with Ion Torrent infrastructure.",
    "biomarkersReported": "SNVs, Indels, CNVs, Fusions, HRD, TMB, MSI",
    "fdaStatus": "RUO",
    "tmb": "Yes",
    "msi": "Yes",
    "reimbursement": "Coverage varies",
    "clinicalAvailability": "RUO kit",
    ...
    "tat": "3 days",
    "tatNotes": "3 days from sample prep to report on GeneStudio S5 (updated from vendor, March 2026)",
    "sensitivity": null,
    "sensitivityNotes": "Analytical performance (GeneStudio S5, multicenter n=193, 5 countries): SNVs 99.6% sens / 97.6% spec, Indels 99.5% / 98.1%, CNV gain 97.6% / 99.9%, CNV loss 86.7% / 99.9%, Fusions 100% / 97.5%. Concordance to orthogonal methods: SNVs 95.3% (n=258), Indels 90.6% (n=32), CNVs 96.5% (n=57), Fusions 96.1% (n=51), HRD 100% (n=18), TMB 81.3% (n=32). MSI sensitivity: Colorectal 98% (n=198), Gastric 100% (n=36), Endometrial 93% (n=97). HRD concordance in ovarian samples (n=86): 98.1% sensitivity, 79.4% specificity, 90.7% overall.",
    "sensitivityCitations": "https://documents.thermofisher.com/TFS-Assets/CSD/Flyers/oncomine-comprehensive-assay-plus-flyer.pdf",
    "totalParticipants": 20000,
    "numPublications": 80,
    "numPublicationsPlus": true,
    ...
    "vendorVerified": true,
    "vendorRequestedChanges": "2026-03-23: Vendor verified by Dinesh Cyanam, Thermo Fisher Scientific. Updated genes 500→517, added biomarkers, sample requirements, citations. 2026-03-25: TAT updated to 3 days (vendor confirmed), CE-IVD dropped (never submitted, RUO only), performance data added from product flyer."
  },
  {
    "id": "tds-kit-19",
    ...
    "requiresMatchedNormal": "No",
    "tat": "24-27 hours",
    "tatNotes": "24-27 hours on Genexus automated platform (vs 3 days on GeneStudio S5). Average 27 hours, as little as 10 minutes from nucleic acid to report.",
    "sensitivity": null,
    "sensitivityNotes": "Analytical performance (Genexus, n=144 FFPE): SNVs 98.6% sens / 99.6% spec, Indels 98.0% / 99.0%, CNV gain 99.6% / 99.9%, CNV loss 98.0% / 99.9%, Fusions 98.0% / 99.0%. MSI: 100% sens / 99.0% spec (n=200). Multicenter concordance (7 countries, n=209): SNVs 99.6% (n=235), CNVs 95.1% (n=61), Fusions 96.7% (n=90), HRD 92.6% (n=27), TMB 100% (n=14), MSI 100% (n=11). GIM/HRD concordance between Genexus and GeneStudio S5: PPA 100%, NPA 100%, OPA 100% (n=12).",
    "sensitivityCitations": "https://documents.thermofisher.com/TFS-Assets/CSD/Flyers/Oncomine-Comprehensive-Assay-Plus-Genexus-Flyer.pdf",
    "totalParticipants": 20000,
    "numPublications": 80,
    "numPublicationsNotes": "Shared publication base with Oncomine Comprehensive Assay Plus (GeneStudio S5)",
    "numPublicationsPlus": true,
    "technologyDifferentiator": "Automated sample-to-report workflow on Genexus platform. Same 517-gene content as GeneStudio S5 version but with 24-27 hour TAT vs 3 days. Slightly different analytical performance profile.",
    "vendorVerified": true,
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://pmc.ncbi.nlm.nih.gov/articles/PMC6734650/",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://www.accessdata.fda.gov/cdrh_docs/reviews/DEN230046.pdf",
    ...
    "specificity": 95,
    "specificityCitations": "https://www.personalgenome.com/products/elio-plasma-focus-dx",
    "specificityNotes": "≥95% analytical specificity in validation studies; >99.9% NPV across variant types",
    "lod": "0.5% MAF",
    "lodCitations": "https://www.personalgenome.com/products/elio-plasma-focus-dx",
  ...
  },
  {
    ...
    "sampleTubeType": "Streck Cell-Free DNA BCT",
    "sampleTubeCount": 1,
    "sampleCitations": "https://www.dlongwood.com/wp-content/uploads/2023/10/Hedera-",
  ...
  {
    "id": "tds-kit-16",
    "name": "MSK-IMPACT powered with SOPHiA DDM",
    "vendor": "SOPHiA GENETICS",
    "productType": "Laboratory IVD Kit",
    "platformRequired": "NovaSeq 6000, NovaSeq X, NextSeq 550/1000/2000",
    "sampleCategory": "Tissue",
    "approach": "Tissue CGP",
    "method": "Hybridization-based capture NGS with CUMIN molecular barcoding for error correction. Matched tumor-normal workflow using FFPE tumor and WBC germline DNA.",
    "genesAnalyzed": 505,
    "cancerTypes": ["Pan-solid tumor"],
    "indicationsNotes": "505-gene panel curated by MSK experts, backed by 900+ publications. Decentralized kit version of centralized MSK-IMPACT test.",
    "biomarkersReported": ["SNVs", "Indels", "CNVs", "DNA fusions", "MSI", "TMB", "TERT promoter mutations", "MET exon 14 skipping"],
    "fdaStatus": "RUO",
    "tmb": "Yes",
    "msi": "Yes",
    "clinicalAvailability": "RUO kit (launched November 2024)",
    "tat": "~5 days (sample to report)",
    "sensitivity": "5% VAF with CUMIN barcoding",
    "sensitivityNotes": "99.3% PPA for SNV/Indel detection vs centralized MSK-IMPACT",
  ...
  },
  {
    ...
    "sampleCategory": "Blood/Plasma",
    "approach": "Liquid CGP",
    "method": "Deep sequencing (~20,000x coverage) ctDNA analysis with matched tumor-normal workflow to filter CHIP and germline variants. Enables longitudinal monitoring.",
    "genesAnalyzed": 147,
    "cancerTypes": ["Pan-solid tumor"],
    "indicationsNotes": "147-gene liquid biopsy panel. Decentralized kit version of MSK-ACCESS test at Memorial Sloan Kettering.",
    "biomarkersReported": ["SNVs", "Indels", "CNVs", "Gene fusions"],
    "fdaStatus": "RUO",
    "clinicalAvailability": "RUO kit",
    "tat": "~5 days (cfDNA to report)",
    "sensitivity": "≥0.5% VAF",
    "sensitivityNotes": "99.4% PPA at ≥0.5% VAF vs centralized MSK-ACCESS",
  ...
  {
    "id": "tds-kit-18",
    "name": "MSK-IMPACT Flex powered with SOPHiA DDM",
    "vendor": "SOPHiA GENETICS",
    "productType": "Laboratory IVD Kit",
    "platformRequired": "NovaSeq 6000, NovaSeq X, NextSeq 550/1000/2000",
    "sampleCategory": "Tissue",
    "approach": "Tissue CGP",
    "method": "Modular DNA and RNA biomarker analysis built on MSK-IMPACT backbone. Automated workflows for DNA, RNA, and HRD testing with integrated analytics and reporting.",
    "genesAnalyzed": 505,
    "cancerTypes": ["Pan-solid tumor"],
    "indicationsNotes": "Flexible/modular version of MSK-IMPACT allowing labs to tailor biomarker testing per case. Includes gene expression analysis capability.",
    "biomarkersReported": ["SNVs", "Indels", "CNVs", "Gene fusions", "Gene expression", "TMB", "MSI", "HRD", "High-resolution CNV"],
    "fdaStatus": "RUO",
    "tmb": "Yes",
    "msi": "Yes",
    "hrd": "Yes",
    "clinicalAvailability": "RUO kit (launched September 2025)",
    "tat": null,
  ...
  // K-4CARE CGP - Added January 2026 (Vendor Submission - David Schlesinger, Gene Solutions)
  {
    "id": "tds-28",
    "sampleCategory": "Tissue",
    "name": "K-4CARE",
    ...
    "sensitivity": 99,
    "sensitivityNotes": ">99% sensitivity for somatic SNVs, Indels, and amplifications; 94% for gene fusions",
    "sensitivityCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "specificity": 99,
    "specificityNotes": ">99% specificity across all variant types",
    "specificityCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "specificityPlus": true,
    "requiresTumorTissue": "Yes",
    "requiresTumorTissueNotes": "FFPE tumor tissue required",
    "requiresMatchedNormal": "Yes",
    "requiresMatchedNormalNotes": "Peripheral blood for germline filtering",
    "fdaStatus": "Not FDA cleared",
    "fdaStatusNotes": "US validation underway with Pangea Laboratory",
    "fdaCompanionDxCount": 0,
    "reimbursement": "Not covered",
    "reimbursementNote": "No US coverage",
    "clinicalAvailability": "Commercial in Asian markets; US launch planned",
    ...
    "numPublications": 1,
    "numPublicationsCitations": "https://pubmed.ncbi.nlm.nih.gov/38404964/",
    "numPublicationsNotes": "Frontiers in Molecular Biosciences (2024) - 100% concordance with TruSight Oncology 500 for somatic variants",
    "isRUO": false,
    "isInvestigational": false,
    "isClinicalLDT": true,
    "regulatoryStatusNotes": "CAP-accredited NGS laboratories",
  ...
  },
  {
    ...
    "numPublications": 100,
    "numPublicationsPlus": true,
    "numPublicationsNotes": "Extensively validated with 100+ peer-reviewed publications. Key recent: STAMPEDE Phase 3 (Cell Aug 2025, 36% death risk reduction in high GC with chemo) and BALANCE (ASTRO Oct 2025, hormone therapy prediction in recurrent disease).",
    "performanceNotes": "STAMPEDE Phase 3 (Cell Aug 2025): Patients with high Decipher GC scores who received docetaxel + SOC had 36% reduction in death risk vs SOC alone. BALANCE (ASTRO Oct 2025): Decipher predicted benefit from extended hormone therapy in recurrent prostate cancer.",
    "performanceCitations": "https://doi.org/10.1016/j.cell.2025.08.XXX | ASTRO 2025 BALANCE abstract",
    "vendorVerified": false,
    "isClinicalLDT": true,
...
export const hctTestData = [
  {
    ...
    "sampleType": "Whole blood (EDTA) or saliva (Oragene kit)",
    "sampleVolume": "3-5 mL blood or 2 mL saliva",
    "method": "NGS with deletion/duplication analysis; includes RiskScore (polygenic risk) for breast cancer",
    "methodCitations": "https://myriad.com/genetic-tests/myrisk-hereditary-cancer/technical-specifications/",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 63,
    "genesAnalyzedCitations": "https://myriad.com/gene-table/",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "EPCAM", "APC", "MUTYH", "TP53", "PTEN", "PALB2", "CHEK2", "ATM"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "Cowden", "FAP", "MUTYH-Associated Polyposis"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Endometrial", "Pancreatic", "Prostate", "Gastric", "Melanoma"],
    "analyticalSensitivity": 99.9,
    "analyticalSensitivityNotes": ">99% for sequencing and large rearrangements; Sanger confirmation of variants",
    "analyticalSpecificity": 99.9,
    "vusRateNotes": "Myriad claims lowest VUS rates in industry due to 25+ years of data and largest hereditary cancer database",
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA Certified, CAP Accredited",
    "nyApproved": true,
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Commercial, Medicare, Medicaid; 97% of private insurance covers hereditary cancer testing",
    "selfPayPrice": 249,
    "selfPayPriceCitations": "https://myriad.com/patients-families/myrisk-testing-options/",
    "financialAssistance": "Myriad Financial Assistance Program; free cascade testing for relatives within 90 days",
    "cptCodes": "81162, 81211, 81213, 81214",
    "medicareRate": 1824.88,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    "tat": "14 days",
    "tatCitations": "https://myriad.com/genetic-tests/myrisk-hereditary-cancer/",
    "availableRegions": ["US", "International"],
    "reportIncludes": ["Variant classification", "RiskScore (Polygenic)", "Management guidelines", "Family letter"],
    "geneticCounselingIncluded": "Optional (free post-test with Myriad GC)",
    "cascadeTestingOffered": "Yes - free for blood relatives within 90 days",
    "variantReclassificationPolicy": true,
    "numPublications": 1000,
    "numPublicationsNotes": "Extensive publication history; Myriad's hereditary cancer database is the largest in the industry",
    "uniqueFeatures": "Integrates Polygenic Risk Score (PRS) for breast cancer; RiskScore provides precise risk for women who test negative for mutations; largest hereditary cancer database",
    "limitations": "Panel size (63 genes) smaller than some competitors (80+)",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    "id": "hct-2",
    "category": "HCT",
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "sampleType": "Whole blood or saliva",
    "sampleVolume": "4 mL blood or 2 mL saliva",
    "method": "NGS with deletion/duplication analysis",
    "methodCitations": "https://www.invitae.com/providers/test-catalog/test-01101",
    "sequencingPlatform": "Illumina NovaSeq",
    "genesAnalyzed": 84,
    "genesAnalyzedCitations": "https://www.invitae.com/providers/test-catalog/test-01101",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "EPCAM", "APC", "TP53", "PTEN", "STK11", "CDH1"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "Cowden", "Peutz-Jeghers", "Hereditary Diffuse Gastric Cancer"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Uterine", "Colorectal", "Gastric", "Pancreatic", "Prostate", "Melanoma", "Thyroid", "Kidney", "Brain", "Sarcoma"],
    "analyticalSensitivity": 99.5,
    "analyticalSpecificity": 99.9,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA Certified, CAP Accredited",
    "nyApproved": true,
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Commercial, Medicare",
    "listPrice": 250,
    "selfPayPrice": 250,
    "selfPayPriceCitations": "https://www.invitae.com/us/providers/billing",
    "financialAssistance": "Invitae Patient Assistance Program; free family testing for 90 days",
    "cptCodes": "81432, 81433",
    "medicareRate": 1303.95,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    "tat": "10-21 days",
    "availableRegions": ["US", "International"],
    "reportIncludes": ["Variant classification", "Management guidelines"],
    "geneticCounselingIncluded": "Yes - includes post-test counseling",
    "cascadeTestingOffered": "Yes - free for 90 days",
    "variantReclassificationPolicy": true,
    "pediatricTesting": true,
    "uniqueFeatures": "Add-on genes available; re-requisition policy allows adding genes later",
    "limitations": "Brand in transition post-acquisition by Labcorp (completed late 2024); operational backend transitioning",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "sampleType": "Whole blood or saliva",
    "sampleVolume": "3-7 mL blood or 2 mL saliva",
    "method": "NGS (sequencing and deletion/duplication)",
    "methodCitations": "https://blog.ambrygen.com/ambry/post/361/2024-hereditary-cancer-testing-menu-update",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 90,
    "genesAnalyzedCitations": "https://blog.ambrygen.com/ambry/post/361/2024-hereditary-cancer-testing-menu-update",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "PALB2", "ATM", "CHEK2", "NBN", "BARD1"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "Cowden", "FAP", "PHTS", "VHL"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Uterine", "Pancreatic", "Prostate", "Renal", "Thyroid", "Paraganglioma"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99.9,
    "vusRateNotes": "Ambry known for rigorous variant classification and data sharing to reduce VUS",
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA Certified, CAP Accredited",
    "nyApproved": true,
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Insurance/Medicare",
    "financialAssistance": "Patient Assistance Program available",
    "cptCodes": "81432, 81433",
    "medicareRate": 1303.95,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    ...
    "availableRegions": ["US"],
    "reportIncludes": ["Variant classification", "Management guidelines"],
    "geneticCounselingIncluded": "No - relies on provider GC",
    "cascadeTestingOffered": "Yes - Family Testing Program",
    "variantReclassificationPolicy": true,
    "numPublications": 50,
    "numPublicationsCitations": "https://pubmed.ncbi.nlm.nih.gov/24763289/",
    "numPublicationsNotes": "LaDuca et al. 2014 (PMID: 24763289) and extensive follow-up publications",
    "uniqueFeatures": "+RNAinsight available (paired RNA/DNA testing) to improve VUS resolution; updated to 90 genes per 2024 menu update",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "sampleType": "Whole blood or saliva kit",
    "sampleVolume": "10 mL blood or saliva kit",
    "method": "NGS with deletion/duplication",
    "methodCitations": "https://www.natera.com/oncology/empower-hereditary-cancer-test/",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 81,
    "genesAnalyzedCitations": "https://www.natera.com/oncology/empower-hereditary-cancer-test/",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "EPCAM", "TP53", "PTEN"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Uterine", "Colorectal", "Gastric", "Pancreatic", "Prostate", "Melanoma"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99.9,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA Certified",
    "nyApproved": true,
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Insurance/Medicare",
    "selfPayPrice": 249,
    "selfPayPriceCitations": "https://www.natera.com/billing/",
    "financialAssistance": "Compassionate Care Program",
    "tat": "2-3 weeks",
    "availableRegions": ["US"],
    "reportIncludes": ["Variant classification", "Management guidelines"],
    "geneticCounselingIncluded": "Yes - pre- and post-test sessions available",
    "cascadeTestingOffered": "Yes",
    "variantReclassificationPolicy": true,
    "uniqueFeatures": "Often bundled with Natera's Signatera (MRD) test for cancer patients; 81 genes covers all NCCN-guideline genes",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Saliva",
    "sampleType": "Saliva collection kit",
    "sampleVolume": "2 mL saliva",
    "method": "NGS",
    "methodCitations": "https://www.color.com/learn/genes-tested-hereditary-cancer",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 30,
    "genesAnalyzedCitations": "https://www.color.com/learn/genes-tested-hereditary-cancer",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "EPCAM", "APC", "CHEK2", "ATM", "PALB2", "PTEN", "TP53"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "FAP", "MAP", "Cowden", "Peutz-Jeghers"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Uterine", "Colorectal", "Melanoma", "Pancreatic", "Prostate", "Stomach"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA Certified, CAP Accredited",
    "nyApproved": true,
    "reimbursement": "Self-Pay / Employer",
    "reimbursementNotes": "Largely pivoted to enterprise/employer health programs",
    "listPrice": 250,
    "selfPayPrice": 250,
    "financialAssistance": "Family Testing Program - reduced cost for family members",
    "tat": "3-5 weeks",
    "availableRegions": ["US"],
    "reportIncludes": ["Variant classification", "Risk information"],
    "geneticCounselingIncluded": "Yes - included in cost",
    "cascadeTestingOffered": "Yes",
    "variantReclassificationPolicy": true,
    "minimumAge": 18,
    "uniqueFeatures": "Focus on accessibility and user experience; 30-gene panel covers most actionable risks; strong employer/enterprise market presence",
    "limitations": "Smaller panel than Myriad/Invitae; TAT is slower (3-5 weeks)",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleVolume": "5 mL",
    "method": "NGS with Deletion/Duplication",
    "methodCitations": "https://testdirectory.questdiagnostics.com/test/test-detail/38600/",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 66,
    "genesAnalyzedCitations": "https://testdirectory.questdiagnostics.com/test/test-detail/38600/",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "APC", "MUTYH", "TP53", "PTEN", "STK11", "CDH1"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "Cowden", "FAP"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Endometrial", "Pancreatic", "Prostate", "Gastric"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    ...
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Insurance/Medicare",
    "financialAssistance": "Quest Financial Assistance",
    "cptCodes": "81432, 81433",
    "medicareRate": 1303.95,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    "tat": "14-21 days",
    "availableRegions": ["US"],
    "reportIncludes": ["Variant classification"],
    "geneticCounselingIncluded": "Optional - through partners",
    "cascadeTestingOffered": "No - standard ordering required",
    "variantReclassificationPolicy": true,
    "uniqueFeatures": "Broad access via Quest patient service centers nationwide",
    "limitations": "Less specialized than dedicated genetic labs (Myriad/Ambry)",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleVolume": "10 mL blood",
    "method": "NGS with Deletion/Duplication",
    "methodCitations": "https://womenshealth.labcorp.com/providers/hereditary-cancer/vistaseq",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 27,
    "genesAnalyzedCitations": "https://womenshealth.labcorp.com/providers/hereditary-cancer/vistaseq",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "EPCAM", "APC", "MUTYH", "TP53", "PTEN"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "FAP", "Cowden"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Pancreatic", "Prostate"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    ...
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Insurance/Medicare",
    "financialAssistance": "Labcorp Patient Assistance",
    "cptCodes": "81432, 81433",
    "medicareRate": 1303.95,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    ...
    "availableRegions": ["US"],
    "reportIncludes": ["Variant classification"],
    "geneticCounselingIncluded": "Optional - Integrated Genetics counselors available",
    "cascadeTestingOffered": "Yes - mutation-specific testing available",
    "variantReclassificationPolicy": true,
    "uniqueFeatures": "Integrated with Labcorp's massive distribution network; focused on high-penetrance actionable genes",
    "limitations": "27-gene panel is smaller than 'Comprehensive' panels from competitors; tighter focus on most actionable genes",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleVolume": "4 mL",
    "method": "NGS with Deletion/Duplication",
    "methodCitations": "https://www.tempus.com/oncology/genetic-testing/hereditary-cancer/",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 52,
    "genesAnalyzedNotes": "xG = 52 genes; xG+ = 88 genes",
    "genesAnalyzedCitations": "https://www.tempus.com/oncology/genetic-testing/hereditary-cancer/",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "PALB2", "ATM", "CHEK2"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Pancreatic", "Prostate", "Endometrial"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99.9,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    ...
    "reimbursementNotes": "Insurance/Medicare",
    "selfPayPrice": 250,
    "financialAssistance": "Tempus Financial Assistance",
    "tat": "2 weeks",
    "availableRegions": ["US"],
    "reportIncludes": ["Variant classification", "Clinical Guidelines"],
    "geneticCounselingIncluded": "Optional",
    "cascadeTestingOffered": "Yes",
    "variantReclassificationPolicy": true,
    "uniqueFeatures": "Seamlessly integrates with xT tumor profiling; germline analysis performed by partner lab (GeneDx); allows oncologists to order both tumor and hereditary tests together",
    "limitations": "Germline testing outsourced to GeneDx",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleVolume": "2-5 mL",
    "method": "NGS with Deletion/Duplication",
    "methodCitations": "https://providers.genedx.com/Resources/TIS-Files/TIS-B275.pdf",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 49,
    "genesAnalyzedCitations": "https://providers.genedx.com/Resources/TIS-Files/TIS-B275.pdf",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "APC", "MUTYH", "TP53", "PTEN"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "FAP", "Cowden", "Peutz-Jeghers"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Pancreatic", "Prostate", "Uterine", "Melanoma"],
    "analyticalSensitivity": 99,
    "analyticalSpecificity": 99.9,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    ...
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Insurance/Medicare",
    "financialAssistance": "Financial Assistance Program",
    "cptCodes": "81432, 81433",
    "medicareRate": 1303.95,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    ...
    "variantReclassificationPolicy": true,
    "pediatricTesting": true,
    "uniqueFeatures": "Expertise in rare diseases; often handles complex cases; powers Tempus xG germline testing",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "sampleType": "Whole blood or saliva",
    "sampleVolume": "4 mL blood",
    "method": "NGS with Deletion/Duplication",
    "methodCitations": "https://www.fulgentgenetics.com/comprehensivecancer-full",
    "sequencingPlatform": "Illumina",
    "genesAnalyzed": 154,
    "genesAnalyzedCitations": "https://www.fulgentgenetics.com/comprehensivecancer-full",
    "keyGenes": ["BRCA1", "BRCA2", "MLH1", "MSH2", "MSH6", "PMS2", "EPCAM", "APC", "TP53", "PTEN", "PALB2", "ATM", "CHEK2"],
    "syndromesDetected": ["HBOC", "Lynch Syndrome", "Li-Fraumeni", "Cowden", "FAP", "All major syndromes"],
    "cancerTypesAssessed": ["Breast", "Ovarian", "Colorectal", "Endometrial", "Pancreatic", "Prostate", "Gastric", "Renal", "Thyroid", "Brain", "Sarcoma", "Hematologic"],
    "analyticalSensitivity": 99.9,
    "analyticalSensitivityNotes": ">99% at 50x coverage",
    "analyticalSpecificity": 99.9,
    "deletionDuplicationAnalysis": "Yes",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "CLIA Certified, CAP Accredited",
    ...
    "reimbursement": "Broad Coverage",
    "reimbursementNotes": "Insurance/Medicare",
    "financialAssistance": "Financial Assistance Available",
    "cptCodes": "81432, 81433",
    "medicareRate": 1303.95,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    ...
    "reportIncludes": ["Variant classification"],
    "geneticCounselingIncluded": "Optional",
    "cascadeTestingOffered": "Yes - single gene testing for relatives",
    "variantReclassificationPolicy": true,
    "pediatricTesting": true,
    "uniqueFeatures": "Largest panel available (154 genes); offers pediatric-specific panels; appeals to specialists wanting comprehensive coverage",
    "limitations": "Large gene lists increase VUS rate",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-08: Added via OpenOnco HCT category launch"
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "genesAnalyzed": 18,
    "genesAnalyzedCitations": "https://www.invitae.com/providers/test-catalog/test-01202",
    "keyGenes": ["BRCA1", "BRCA2", "PALB2", "TP53", "PTEN", "CDH1", "ATM", "CHEK2"],
    "syndromesDetected": ["HBOC", "Li-Fraumeni", "Cowden", "Hereditary Diffuse Gastric Cancer"],
    "fdaStatus": "CLIA LDT",
    "nyApproved": "Varies by test / state rules",
    "tat": "Varies by order",
    "tatCitations": "https://www.invitae.com/providers/test-catalog/test-01202",
    "vendorVerified": false,
  ...
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "genesAnalyzed": 13,
    "genesAnalyzedCitations": "https://www.invitae.com/providers/test-catalog/test-01206",
    "keyGenes": ["BRCA1", "BRCA2", "TP53", "PTEN", "STK11", "PALB2", "CDH1", "ATM", "CHEK2"],
    "syndromesDetected": ["HBOC", "Li-Fraumeni", "Cowden", "Peutz-Jeghers", "Hereditary Diffuse Gastric Cancer"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "sampleType": "3 mL whole blood in purple-top EDTA tube; alternate: saliva",
    "genesAnalyzed": 2,
    "genesAnalyzedCitations": "https://www.invitae.com/providers/test-catalog/test-50002",
    "keyGenes": ["BRCA1", "BRCA2"],
    "syndromesDetected": ["HBOC"],
    "fdaStatus": "CLIA LDT",
    "nyApproved": true,
    "tat": "5–12 calendar days (7 days on average)",
    "tatCitations": "https://www.invitae.com/providers/test-catalog/test-50002",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "genesAnalyzed": 8,
    "genesAnalyzedCitations": "https://www.invitae.com/providers/test-catalog/test-01301",
    "keyGenes": ["RET", "PTEN", "APC", "DICER1", "PRKAR1A", "SDHB", "SDHD", "TP53"],
    "cancerTypesAssessed": ["Thyroid"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "method": "NGS germline multi-gene panel",
    "methodCitations": "https://www.invitae.com/providers/test-catalog/test-01261",
    "cancerTypesAssessed": ["Pancreatic"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "method": "Germline hereditary cancer focused subpanel",
    "methodCitations": "https://oncology.labcorp.com/vistaseq-hereditary-cancer",
    "cancerTypesAssessed": ["Breast"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "method": "Germline hereditary cancer focused subpanel",
    "methodCitations": "https://oncology.labcorp.com/vistaseq-hereditary-cancer",
    "cancerTypesAssessed": ["Colorectal"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  ...
  },
  {
    ...
    "method": "Germline hereditary cancer focused subpanel",
    "methodCitations": "https://oncology.labcorp.com/vistaseq-hereditary-cancer",
    "cancerTypesAssessed": ["Endometrial"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  ...
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "genesAnalyzed": 1,
    "genesAnalyzedCitations": "https://oncology.labcorp.com/assets-media/2277",
    "keyGenes": ["BRCA1"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  ...
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood",
    "method": "Germline hereditary cancer testing; comprehensive panel",
    "methodCitations": "https://www.fulgentgenetics.com/products/oncology/hereditarycancer.html",
    "genesAnalyzed": 154,
    "genesAnalyzedCitations": "https://fulgentgenetics.com/content/flyer/FLY-Hereditary_Cancer-2024-V1.pdf",
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "vendor": "PreventionGenetics (Abbott)",
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "method": "NGS with CNV (PGselect Platform)",
    "methodCitations": "https://www.preventiongenetics.com/tests/gastric-cancer-panel",
    "genesAnalyzed": 19,
    "genesAnalyzedCitations": "https://www.preventiongenetics.com/tests/gastric-cancer-panel",
    "cancerTypesAssessed": ["Gastric"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "genesAnalyzed": 1,
    "genesAnalyzedCitations": "https://www.preventiongenetics.com/tests/pten-hamartoma-tumor-syndrome-via-the-pten-gene",
    "keyGenes": ["PTEN"],
    "syndromesDetected": ["Cowden Syndrome / PTEN Hamartoma Tumor Syndrome"],
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  ...
  },
  {
    ...
    "productType": "Central Lab Service",
    "sampleCategory": "Blood or Saliva",
    "method": "Expanded germline testing offering",
    "methodCitations": "https://www.foundationmedicine.com/test/germline-testing",
    "fdaStatus": "CLIA LDT",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "sampleCategory": "Blood or Saliva",
    "genesAnalyzed": 2,
    "genesAnalyzedCitations": "https://www.accessdata.fda.gov/cdrh_docs/pdf14/P140020b.pdf",
    "keyGenes": ["BRCA1", "BRCA2"],
    "fdaStatus": "FDA Approved (PMA)",
    "fdaStatusNotes": "FDA-approved companion diagnostic for PARP inhibitors",
    "cptCodes": "0137U",
    "medicareRate": 282.88,
    "medicareStatus": "Priced",
    "medicareEffective": "2025-Q4",
    "adltStatus": true,
    "cptCodesNotes": "BRACAnalysis CDx PLA code for full BRCA1/2 sequencing plus large rearrangement analysis.",
    "vendorVerified": false,
    "vendorRequestedChanges": "2026-01-09: Initial entry from batch submission"
  },
  {
    ...
    "sampleCategory": "Saliva",
    "genesAnalyzed": 2,
    "genesAnalyzedCitations": "https://www.23andme.com/en-int/company-stories/fda-authorizes-first-direct-to-consumer-test-for-breast-cancer-risk/",
    "keyGenes": ["BRCA1", "BRCA2"],
    "fdaStatus": "DTC FDA Authorized",
    "fdaStatusNotes": "Limited to 3 Ashkenazi Jewish founder mutations; not comprehensive BRCA sequencing",
  ...
  // Risk MAPS - Added January 2026 (Protean BioDiagnostics)
  {
    "id": "hct-34",
    "sampleCategory": "Saliva",
    "name": "Risk MAPS",
    "vendor": "Protean BioDiagnostics",
    "approach": "Whole exome sequencing",
    "method": "Whole exome analysis of germline DNA from saliva. Evaluates 22,000+ genes with focused cancer-predisposition gene analysis. Offers comprehensive and site-specific panels. Data retained for future reanalysis.",
    "methodCitations": "https://www.proteanbiodx.com/riskmaps",
    "genesAnalyzed": 22000,
    "genesAnalyzedNotes": "Whole exome (22,000+ genes). Comprehensive cancer panel or site-specific panels available (breast, colorectal, gastric, ovarian, prostate, pancreatic).",
    "cancerTypes": ["Breast", "Ovarian", "Colorectal", "Gastric", "Prostate", "Pancreatic"],
    "cancerTypesNotes": "Hereditary cancer syndromes including HBOC, Lynch syndrome, FAP, Peutz-Jeghers. Site-specific panels available.",
    "cancerTypesCitations": "https://www.proteanbiodx.com/riskmaps",
    "sampleTubeType": "Saliva collection kit",
    "sampleTubeCount": 1,
    "sampleCollectionNotes": "Saliva sample. Easy home collection.",
    "sampleCitations": "https://www.proteanbiodx.com/riskmaps",
    "fdaStatus": "CLIA LDT",
    "fdaStatusNotes": "Not FDA cleared. CLIA-certified, CAP-accredited laboratory.",
    "reimbursement": "Variable",
    "reimbursementNote": "Coverage varies by payer and indication. Genetic counseling available.",
    "clinicalAvailability": "Commercially available",
    "availableRegions": ["US"],
    "isRUO": false,
    "isInvestigational": false,
...
export const DATABASE_CHANGELOG = [
  ...
  },
  {
    ...
    vendor: 'ClearNote Health',
    category: 'ECD',
    description: 'Enhanced test update: multianalyte/multiomic assay with improved performance (sensitivity 82.6%, early-stage 76.8%, specificity 97.5%). Corrected Medicare coverage to not covered. Corrected list price from $495 to $1,160 CLFS rate.',
  ...
  },
  {
    ...
    vendor: 'Natera',
    category: 'MRD',
    description: 'Added Humana and BCBS Michigan to non-coverage list. Humana liquid biopsy policy explicitly excludes Signatera (0340U). BCBS MI Policy 2002479 (eff. 1/1/26) lists MRD testing as investigational.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Weekly triage 2026-02-09; Humana Liquid Biopsy policy; BCBS MI Policy 2002479'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Biodesix',
    category: 'TRM',
    description: 'Added Humana to non-coverage list. Humana liquid biopsy policy explicitly excludes NavDx (0356U) as not meeting coverage criteria.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Weekly triage 2026-02-09; Humana Liquid Biopsy policy'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'GRAIL',
    category: 'ECD',
    description: 'Added PATHFINDER 2 supplemental performance data: >50% of Galleri-detected cancers were early-stage; ~75% were cancer types without recommended standard screenings.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Weekly triage 2026-02-09; PATHFINDER 2 study supplemental results'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Quest Diagnostics',
    category: 'MRD',
    description: 'Added ASCO GI 2026 presentation details: Abstract 26 (Tie et al.) on reproducibility/concordance in resected CRC from DYNAMIC trials; Abstract 30 (Christenson et al.) on ctDNA monitoring during TNT for locally advanced rectal cancer.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Quest Diagnostics press release Jan 6 2026; ASCO GI 2026 Abstracts 26, 30'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Illumina',
    category: 'TDS',
    description: 'Added CMS reimbursement data: PLA code 0543U, CLFS rate $2,989.55 effective Jan 1 2026, NCD 90.2 coverage with CDx claims for NTRK fusions and RET fusions in NSCLC.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'CMS CLFS 2026; FDA PMA P230011'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    testId: null,
    testName: 'Natera PAP (all oncology tests)',
    vendor: 'Natera',
    category: 'MRD',
    description: 'Updated Natera Patient Assistance Program with detailed pricing: Financial Assistance $0–$149 (income-based), Prompt-Pay Cash $349 (Signatera), interest-free 12-month payment plans. Updated care.natera.com application URL.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Natera billing page; care.natera.com'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Quest Diagnostics',
    category: 'MRD',
    description: 'Added NEJM Apr 2025 landmark publication: ctDNA detected at median 1.4 months post-surgery vs 6.1 months for imaging. Added lead time vs imaging data. ASCO GI 2026 presentations.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'NEJM Apr 2025 (DOI: 10.1056/NEJMoa2502029)'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'NeoGenomics',
    category: 'MRD',
    description: 'Added SABCS 2025 breast cancer data: CLEVER 5-year study and SURVIVE HERoes Phase III. Updated clinical trials and publication count.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'SABCS 2025; NeoGenomics investor news'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Personalis',
    category: 'MRD',
    description: 'Added TRACERx NSCLC data (Cell Dec 2025, 431 pts, 5x relapse risk), CALLA cervical cancer trial (16-month lead time), immunotherapy monitoring (npj Precision Oncology Feb 2026). Updated total participants to 924.',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Cell Dec 2025 (TRACERx); npj Precision Oncology Feb 2026'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Veracyte',
    category: 'TDS',
    description: 'Added STAMPEDE Phase 3 data (Cell Aug 2025, 36% death risk reduction with docetaxel in high GC) and BALANCE (ASTRO Oct 2025, hormone therapy benefit prediction).',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Cell Aug 2025 (STAMPEDE); ASTRO 2025 (BALANCE)'
  },
  {
    date: 'Feb 9, 2026',
    type: 'updated',
    ...
    vendor: 'Caris Life Sciences',
    category: 'MRD',
    description: 'Added MCED validation data (Nature Sci Reports Jul 2025, 83–96% sensitivity). MI Cancer Seek CDx independent validation (Oncotarget Aug 2025, 97–100% concordance). GPSai AI tool (95% tissue-of-origin accuracy). T-DXd resistance mechanisms (npj Breast Cancer Feb 2026).',
    contributor: null,
    affiliation: 'OpenOnco',
    citation: 'Nature Scientific Reports Jul 2025; Oncotarget Aug 2025; Cancer Res Commun Sep 2025; npj Breast Cancer Feb 2026'
  },
  {
    date: 'Feb 5, 2026',
    type: 'added',
  ...
  },
  {
    date: 'Jan 31, 2026',
    type: 'added',
    testId: 'ecd-29, ecd-30, hct-34',
    testName: 'ClarityDX Prostate, OnkoSkan, Risk MAPS',
    vendor: 'Protean BioDiagnostics',
    category: 'ECD, HCT',
    description: 'Added 3 Protean BioDiagnostics tests: ClarityDX Prostate (ML prostate cancer risk prediction, Nature 2024), OnkoSkan (hPG80 pan-cancer biomarker, EBioMedicine 2020), and Risk MAPS (whole exome hereditary cancer testing).',
    contributor: 'OpenOnco',
    affiliation: 'OpenOnco'
  },
  {
    ...
    vendor: 'Rapid Novor',
    category: 'MRD',
    description: 'New MRD test for multiple myeloma using clonotypic peptides mass spectrometry. Blood-based (no bone marrow), tumor-naive approach. 1000x more sensitive than SPEP, no therapeutic antibody interference. CLIA LDT available in US/Canada.',
    contributor: 'Jenna Kerry',
    affiliation: 'Rapid Novor',
    citation: 'https://doi.org/10.1158/1078-0432.CCR-21-0649'
  },
  {
    date: 'Jan 28, 2026',
    type: 'added',
    testId: 'tds-kit-16, tds-kit-17, tds-kit-18',
    testName: 'MSK-IMPACT, MSK-ACCESS, MSK-IMPACT Flex',
    vendor: 'SOPHiA GENETICS',
    category: 'TDS',
    description: 'Added 3 SOPHiA GENETICS MSK decentralized CGP kits: MSK-IMPACT (505-gene tissue), MSK-ACCESS (147-gene liquid), and MSK-IMPACT Flex (modular tissue+RNA). All RUO. Vendor submission from Lina Li.',
    contributor: 'Lina Li',
  ...
  },
  {
    date: 'Jan 9, 2026',
    type: 'added',
    testId: 'hct-11 through hct-32',
    testName: 'HCT Category Expansion',
    vendor: 'Multiple',
    category: 'HCT',
    description: 'Added 22 hereditary cancer tests: Invitae site-specific panels (Breast, Breast Guidelines-Based, BRCA1/2 STAT, Thyroid, Pancreatic), VistaSeq site-specific panels (Breast, Colorectal, Ovarian, Endometrial, Gastric, Pancreatic, Prostate, Melanoma), Labcorp BRCAssure BRCA1/BRCA2 targeted analysis, Fulgent Pan-Cancer 154-gene panel, PreventionGenetics Gastric and PTEN panels, Foundation Medicine germline tests, Myriad BRACAnalysis CDx (FDA-approved), and 23andMe DTC BRCA report.',
    contributor: 'OpenOnco',
    affiliation: 'OpenOnco',
    citation: 'https://openonco.org/risk'
  },
  {
    date: 'Jan 8, 2026',
    type: 'added',
    testId: 'hct-1 through hct-10',
    testName: 'HCT Category Launch',
    vendor: 'Multiple',
    category: 'HCT',
    description: 'Launched new Hereditary Cancer Testing (HCT) category with 10 tests: MyRisk (Myriad), Invitae Multi-Cancer Panel, CancerNext-Expanded (Ambry), Empower (Natera), Color Hereditary Cancer, Quest Comprehensive, VistaSeq (Labcorp), xG/xG+ (Tempus), GeneDx Common Cancer Panel, Fulgent Full Comprehensive. Covers germline testing for inherited cancer predisposition syndromes including HBOC, Lynch, Li-Fraumeni.',
    contributor: 'OpenOnco',
    affiliation: 'OpenOnco',
    citation: 'https://openonco.org/risk'
  },
