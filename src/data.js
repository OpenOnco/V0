...
export const ecdTestData = [
    ...
    }},
  {
    ...
    "incidenceAdjustedSensitivityNotes": "Calculated IAS: CCGA-3 cancer-type-specific observed sensitivities (Table S5) weighted by SEER 2021 incidence proportions across 21 cancer types. Lower than observed sensitivity (51.5%) because high-incidence cancers (breast 30.5%, prostate 11.2%) have low detection rates. See scripts/calculate-ias.js for full methodology.",
  ...
  // Cancerguard - Added December 2025 (LLM Data Review)
  {
    ...
    "incidenceAdjustedSensitivityNotes": "Calculated IAS: Clinician Brochure Table 6-4 cancer-type-specific observed sensitivities weighted by SEER 2021 incidence proportions across 18 cancer types (excluding breast and prostate, which are not indicated for CancerGuard). See scripts/calculate-ias.js for full methodology.",
