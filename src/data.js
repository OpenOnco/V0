...
export const ecdTestData = [
  ...
  },
  {
    ...
    "sensitivityType": "Stage I-II combined only (~60.3% finalized; overall all-stages sensitivity not reported)",
    "stageISensitivity": 56.8,
    "stageISensitivityNotes": "Achieve 1 finalized results (March 31, 2026), cross-validation, n=3,014 total evaluable subjects. Stage I sensitivity unchanged from interim.",
    "stageISensitivityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-finalizes-achieve-1-study-results-reinforcing-the-superior-sensitivity-and-specificity-of-caris-detect-302730659.html",
    "stageIISensitivity": 70.1,
    "stageIISensitivityNotes": "From Achieve 1 interim readout (Feb 2026). Finalized press release reports combined Stage I-II ~60.3% but does not separately report Stage II. Retaining interim figure pending specific finalized Stage II data.",
    ...
    "stageIIISensitivity": null,
    "stageIIISensitivityNotes": "Stage III sensitivity not separately reported in Achieve 1 finalized results. Sensitivity ranges from 56.8% (Stage I) to 98.6% (Stage IV) without explicit Stage III breakout.",
    "stageIVSensitivity": 98.6,
    "stageIVSensitivityNotes": "Achieve 1 finalized results (March 31, 2026), n=3,014 evaluable subjects. Stage IV sensitivity slightly lower than interim (99.1%).",
    "stageIVSensitivityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-finalizes-achieve-1-study-results-reinforcing-the-superior-sensitivity-and-specificity-of-caris-detect-302730659.html",
    "specificity": 99.2,
    "specificityNotes": "FINALIZED Achieve 1 results (March 31, 2026; n=3,014): TWO SPECIFICITY VALUES REPORTED: (1) 99.2% in the Asymptomatic Screening Population — subjects with no symptoms, no significant cancer risk factors, and no subsequent cancer diagnosis within 1 year of blood draw. (2) 96.0% in the broader Benign/High-Risk Population. The 99.2% figure is used as the primary specificity as it most closely reflects a true asymptomatic screening use case. Updated from interim (99.1% asymptomatic / 95.3% undiagnosed). For comparison: Galleri 99.5% (n=6,290 non-cancer), Shield MCD 98.5%, Cancerguard 97.4%.",
    "specificityCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-finalizes-achieve-1-study-results-reinforcing-the-superior-sensitivity-and-specificity-of-caris-detect-302730659.html",
    "ppv": null,
    "npv": null,
    "performanceNotes": "STUDY DESIGN: Achieve 1 FINALIZED results (March 31, 2026). Total n=3,014 evaluable subjects (up from 2,122 interim). METHODOLOGY: Cross-validation approach. COHORT ENRICHMENT: The undiagnosed population was enriched for higher-risk subjects — among ~600 subjects with 1-year follow-up, ~7% were subsequently diagnosed with cancer, well above general screening prevalence. FINALIZED vs INTERIM: Stage I sensitivity unchanged (56.8%), Stage IV slightly lower (98.6% vs 99.1%), specificity slightly improved (99.2% vs 99.1% asymptomatic; 96.0% vs 95.3% benign/high-risk). TECHNOLOGY: Caris claims superior early-stage sensitivity vs methylation-only MCED approaches (Galleri, Shield MCD) due to multi-modal genomic analysis covering mutations + epigenomics + transcriptomics + aneuploidy via extreme ultra-deep WGS. An updated assay additionally incorporating Whole Transcriptome Sequencing (WTS) is in development. RELATIONSHIP TO CARIS ASSURE: Caris Detect is a separate forthcoming screening product; Caris Assure is the existing therapy selection liquid biopsy. The July 2025 Scientific Reports publication (Nature journal) validated Caris Assure MCED capability with different performance numbers — do not conflate with Caris Detect Achieve 1 data.",
    "performanceCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-finalizes-achieve-1-study-results-reinforcing-the-superior-sensitivity-and-specificity-of-caris-detect-302730659.html | https://www.prnewswire.com/news-releases/caris-life-sciences-completes-interim-readout-of-achieve-1-study-302699083.html",
    ...
    "fdaStatusNotes": "Caris Detect is a forthcoming MCED test expected to launch H1 2026. Achieve 1 finalized results (March 31, 2026) support commercial launch.",
    "reimbursement": "Not covered",
    ...
    "cptCode": null,
    "screeningInterval": null,
    "clinicalTrials": "Achieve 1 (finalized March 31, 2026; n=3,014 evaluable subjects); Achieve 2 (planned)",
    "clinicalTrialsCitations": "https://www.prnewswire.com/news-releases/caris-life-sciences-finalizes-achieve-1-study-results-reinforcing-the-superior-sensitivity-and-specificity-of-caris-detect-302730659.html",
    "totalParticipants": 3014,
    "totalParticipantsNotes": "Achieve 1 finalized cohort (March 31, 2026); increased from 2,122 interim to 3,014 evaluable subjects",
    "numPublications": 0,
    "numPublicationsNotes": "Zero peer-reviewed publications specific to Caris Detect as of April 2026. All Achieve 1 data (interim Feb 2026 and finalized March 2026) is from press releases only. The July 2025 Scientific Reports (Nature journal) publication validated the Caris Assure platform (separate product) for MCED capability — that paper is not a Caris Detect publication. Peer-reviewed Achieve 1 results have not been published.",
    ...
    "isRUO": false,
    "isInvestigational": true,
    "isInvestigationalNotes": "Pre-launch investigational MCED test; Achieve 1 finalized (March 31, 2026); commercial launch expected H1 2026",
    "isClinicalLDT": false,
    "vendorVerified": false,
    "validationCohortSize": 3014,
    "validationCohortStudy": "Achieve 1 (finalized cross-validation)",
    ...
    "dataSourceNotes": "Data sourced from Achieve 1 finalized press release (March 31, 2026), interim press release (Feb 26, 2026), and Caris/Everlywell partnership announcement (Jan 12, 2026). Performance data is finalized cross-validation (n=3,014). Some cancer-specific sample counts are small (n≤7 for several types)."
  },
...
export const DATABASE_CHANGELOG = [
  ...
  },
  {
    ...
    type: 'updated',
    testId: 'ecd-31',
    testName: 'Caris Detect',
    vendor: 'Caris Life Sciences',
    category: 'ECD',
    description: 'Updated from Achieve 1 interim (n=2,122) to finalized results (March 31, 2026; n=3,014). Stage IV sensitivity: 99.1%→98.6%. Specificity (asymptomatic): 99.1%→99.2%. Specificity (benign/high-risk): 95.3%→96.0%. Stage I sensitivity unchanged at 56.8%.',
    contributor: 'Automated weekly monitor'
  },
  {
    date: 'Mar 25, 2026',
    type: 'new',
