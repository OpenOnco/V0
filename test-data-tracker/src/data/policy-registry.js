...
export const POLICY_REGISTRY = {
  ...
  uhc: {
    ...
    policies: [
      ...
      },
      {
        ...
        url: 'https://www.uhcprovider.com/content/dam/provider/docs/public/policies/comm-medical-drug/molecular-oncology-hematologic-cancer-diagnosis.pdf',
        contentType: 'pdf',
        policyType: 'molecular_oncology',
        docType: 'medical_policy',
        discoveryMethod: 'manual',
  ...
  highmark: {
    ...
    policies: [
      ...
      },
      {
        ...
        docType: 'um_criteria',
        discoveryMethod: 'manual',
        notes: 'CRITICAL: NavDx specific criteria. May be medically necessary when criteria met (prior to surgery OR within 5 years post-op for HPV-driven HNSCC). Static CMS-served HTML. NOTE: securecms.highmark.com has incomplete SSL cert chain — crawlers may need TLS workaround.',
        lastVerified: '2026-02-06',
      },
    ],
  },
    ...
    policies: [
      {
        ...
        policyType: 'liquid_biopsy',
        discoveryMethod: 'google_search',
        notes: 'OUTDATED: Page displays "replaced on January 4, 2021". BCBS MN delegated lab management to eviCore. Use eviCore liquid biopsy guideline (MOL.TS.194.A) for BCBS MN members.',
        lastVerified: '2026-02-06',
        status: 'superseded',
      },
      {
        id: 'bcbsmn-evicore-lab-mgmt',
        name: 'BCBS MN Lab Management Guidelines (via eviCore)',
        url: 'https://www.evicore.com/provider/clinical-guidelines-details?solution=laboratory+management&hPlan=BCBS+MN',
        contentType: 'html',
        policyType: 'liquid_biopsy',
        docType: 'index_page',
        discoveryMethod: 'google_search',
        notes: 'BCBS MN-specific eviCore lab management portal. Contains liquid biopsy guideline MOL.TS.194.A.',
        lastVerified: '2026-02-06',
      },
    ],
  },
  ...
  bcidaho: {
    ...
    tier: 2,
    delegatedTo: 'carelon',
    delegationEffective: '2026-01-01',
    policies: [
      {
        id: 'bcidaho-mp204141',
        ...
        policyType: 'liquid_biopsy',
        discoveryMethod: 'google_search',
        notes: 'RETIRED: BCI transitioned genetic testing to Carelon effective 01/01/2026. Provider portal (providers.bcidaho.com) is non-functional. Use Carelon liquid biopsy guideline (UC0126) for BCI members.',
        lastVerified: '2026-02-06',
        status: 'retired',
      },
    ],
    ...
    policies: [
      {
        ...
        url: 'https://www.policies-wellcare.com/content/dam/centene/wellcare/Medicare/clinicalpolicies/CG-Onc-Liquid-Biopsy-2025.1.pdf',
        contentType: 'pdf',
        policyType: 'liquid_biopsy',
        discoveryMethod: 'google_search',
    ...
    policies: [
      {
        ...
        policyType: 'liquid_biopsy',
        discoveryMethod: 'google_search',
        notes: 'RETIRED: Anthem/Elevance retired GENE.00049 in favor of Carelon clinical guidelines. Use Carelon liquid biopsy guideline (UC0126) for Healthy Blue NC members.',
        lastVerified: '2026-02-06',
        status: 'retired',
      },
    ],
