 ...
 *
 * Provides health, queue, scheduler, and proposal stats endpoints
 */
...
async function handleRequest(req, res) {
  ...
  try {
    ...
    sendJson(res, {
      error: 'Not found',
      message: 'This is the test-data-tracker service.',
      availableEndpoints: ['/health', '/api/queue', '/api/scheduler', '/api/proposals/stats'],
    }, 404);
...
export function startServer() {
  ...
  server.listen(PORT, () => {
    ...
    logger.info('  GET  /api/proposals/stats      - Proposal stats');
  });
